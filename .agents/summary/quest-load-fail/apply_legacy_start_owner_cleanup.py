...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--audit", type=Path,
                        default=Path(".agents/summary/quest-load-fail/quest-order-audit-control-routes.csv"))
    parser.add_argument("--manifest", type=Path,
                        default=Path(".agents/summary/quest-load-fail/legacy-start-owner-cleanup.csv"))
