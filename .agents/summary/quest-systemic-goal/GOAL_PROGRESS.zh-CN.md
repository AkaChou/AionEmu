  ...
  - 剩余多档差异经 audit_tier_axis.py 索引偏移（groups[t] -> groups[t-1]）与 0 值归一修复后，
    ...
    (4) 真实剧情/结局差分任务 21 条：
        - 11 故事抉择差分（全部完成！）：
          ...
          * P5-2：1917（圣所失窃案3结局）、2136（金银斧诚实双档）、2252（击杀米努雅vs特雷基双档）、2303（塔鲁vs雪人草药双档）、2367（术古饰品归还双档）、2448（盗墓团密信双档）、2920（福尔摩斯探案双档）、3088（梅拉果汁情报3档）
        - 2 防具部位三档可选（1687/2677）：三档平铺单池形态（MULTI_TIER_FLATTENED 例外），待窗口合同
        - 4 铸币/兑换多档位（3074/4074 unmapped, 11467/21467 计时档位）
        - 4 主线使命宠物道具削弱档位（14016/24016/14026/24026）：单次使命首通固定获最高档
