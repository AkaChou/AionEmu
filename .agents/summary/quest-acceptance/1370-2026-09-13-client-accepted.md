...
working tree: dirty；本次修复路径为 `CM_DIALOG_SELECT.java`、`QuestEngine.java`、`CMDialogSelectContextTest.java`；`QuestProductionDispatcher.java`、`.agents/summary/quest-load-fail/*` 等既有改动保留未提交，与本验收无关。
