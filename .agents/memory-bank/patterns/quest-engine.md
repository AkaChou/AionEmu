...
keywords: 链式计数、SECTION 链、行不前进、任务书跳行、中间行消失、串行阶梯、counter-grid、组合网格、0/1 计数槽、精锐兵、13918、23918、18033、28033、28313、三槽阶梯、单槽步骤号、6n 位域、旧步骤存档、CHAINED_SECTION_COUNTERS_MUST_BE_SERIAL
-->
