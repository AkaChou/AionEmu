...
| `8080744d7` | 1926/2938 及 20 个同型任务的 `REWARD` packed step 投影错位 | 旧 handler 未改变量时，reward 节点必须保留旧变量；同时用 `ENTER_WORLD` 修复已经持久化的错误 `REWARD var0=1` |
