...
- 生成脚本：`.agents/summary/quest/generate_client_dialog_mapping.py`。
...
```bash
python3 .agents/summary/quest/generate_client_dialog_mapping.py
...
```bash
python3 .agents/summary/quest/generate_quest_dialog_enums.py
...
```bash
python3 .agents/summary/quest/extract_legacy_quest_dialog_contracts.py
python3 .agents/summary/quest/align_client_quest_dialog_lifecycle.py
