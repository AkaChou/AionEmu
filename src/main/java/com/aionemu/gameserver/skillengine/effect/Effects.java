...
public class Effects {
	...
	@XmlElements({ @XmlElement(name = "root", type = RootEffect.class),
			...
			@XmlElement(name = "stun", type = StunEffect.class), @XmlElement(name = "sleep", type = SleepEffect.class),
			@XmlElement(name = "bleed", type = BleedEffect.class), @XmlElement(name = "hide", type = HideEffect.class),
			@XmlElement(name = "search", type = SearchEffect.class),
				@XmlElement(name = "statup", type = StatupEffect.class),
				@XmlElement(name = "casestatup", type = CaseStatUpEffect.class),
				@XmlElement(name = "caseskill", type = CaseSkillEffect.class),
			...
			@XmlElement(name = "dummy", type = DummyEffect.class),
			...
			@XmlElement(name = "fall", type = FallEffect.class), @XmlElement(name = "evade", type = EvadeEffect.class),
