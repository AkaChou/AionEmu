...
public abstract class EffectTemplate {
	...
	private StatEnum getPenetrationStat(StatEnum statEnum) {
        return switch (statEnum) {
            case BLEED_RESISTANCE -> StatEnum.BLEED_RESISTANCE_PENETRATION;
            case BLIND_RESISTANCE -> StatEnum.BLIND_RESISTANCE_PENETRATION;
            case BIND_RESISTANCE -> StatEnum.BIND_RESISTANCE_PENETRATION;
            case CHARM_RESISTANCE -> StatEnum.CHARM_RESISTANCE_PENETRATION;
            case CONFUSE_RESISTANCE -> StatEnum.CONFUSE_RESISTANCE_PENETRATION;
            case CURSE_RESISTANCE -> StatEnum.CURSE_RESISTANCE_PENETRATION;
            case DISEASE_RESISTANCE -> StatEnum.DISEASE_RESISTANCE_PENETRATION;
            case DEFORM_RESISTANCE -> StatEnum.DEFORM_RESISTANCE_PENETRATION;
            case FEAR_RESISTANCE -> StatEnum.FEAR_RESISTANCE_PENETRATION;
            case NOFLY_RESISTANCE -> StatEnum.NOFLY_RESISTANCE_PENETRATION;
            case OPENAREIAL_RESISTANCE -> StatEnum.OPENAREIAL_RESISTANCE_PENETRATION;
            case PARALYZE_RESISTANCE -> StatEnum.PARALYZE_RESISTANCE_PENETRATION;
            case PERIFICATION_RESISTANCE -> StatEnum.PERIFICATION_RESISTANCE_PENETRATION;
            case POISON_RESISTANCE -> StatEnum.POISON_RESISTANCE_PENETRATION;
            case PULLED_RESISTANCE -> StatEnum.PULLED_RESISTANCE_PENETRATION;
            case ROOT_RESISTANCE -> StatEnum.ROOT_RESISTANCE_PENETRATION;
            case SILENCE_RESISTANCE -> StatEnum.SILENCE_RESISTANCE_PENETRATION;
            case SIMPLE_ROOT_RESISTANCE -> StatEnum.SIMPLE_ROOT_RESISTANCE_PENETRATION;
            case SLEEP_RESISTANCE -> StatEnum.SLEEP_RESISTANCE_PENETRATION;
            case SLOW_RESISTANCE -> StatEnum.SLOW_RESISTANCE_PENETRATION;
            case SNARE_RESISTANCE -> StatEnum.SNARE_RESISTANCE_PENETRATION;
            case SPIN_RESISTANCE -> StatEnum.SPIN_RESISTANCE_PENETRATION;
            case STAGGER_RESISTANCE -> StatEnum.STAGGER_RESISTANCE_PENETRATION;
            case STUMBLE_RESISTANCE -> StatEnum.STUMBLE_RESISTANCE_PENETRATION;
            case STUN_RESISTANCE -> StatEnum.STUN_RESISTANCE_PENETRATION;
            default -> null;
        };
	}
