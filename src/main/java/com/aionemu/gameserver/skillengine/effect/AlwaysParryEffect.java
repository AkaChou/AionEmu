...
/**
 * 必定招架效果：在限定次数内强制将攻击判定为 PARRY。
 * Always-parry effect: forces PARRY attack status for a limited number of hits.
 *
 * @author ATracer
 */
...
public class AlwaysParryEffect extends EffectTemplate {
	...
	/**
	 * 注册攻击判定观察者，命中 PARRY 时消耗次数并可能结束效果。
	 * Registers an attack-calc observer; PARRY hits consume charges and may end the effect.
	 *
	 * @param effect 运行时效果 / runtime effect
	 */
	@Override
