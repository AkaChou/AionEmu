...
public abstract class DamageEffect extends EffectTemplate {
	...
	public boolean calculate(Effect effect, DamageType damageType) {
		...
		case PHYSICAL:
			...
			AttackUtil.calculateSkillResult(effect, valueWithDelta, modifier, this.getMode(), rndDmg, accMod,
		...
		case MAGICAL:
			...
			AttackUtil.calculateMagicalSkillResult(effect, valueWithDelta, modifier, getElement(), true, useKnowledge,
					false, this.getMode(), this.critProbMod2, critAddDmg, shared, false);
			break;
		default:
