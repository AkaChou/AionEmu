...
/**
 * 微光修道院任务脚本：Protect Cascade Springs（任务 ID 19657）。
 * Wisplight Abbey quest script: Protect Cascade Springs (quest ID 19657).
 *
 * @author Rinzler (Encom)
 */
public class _19657Protect_Cascade_Springs extends QuestHandler {

	private final static int questId = 19657;
	private final static int[] mobs = {210795, 210796, 210803, 210813};
