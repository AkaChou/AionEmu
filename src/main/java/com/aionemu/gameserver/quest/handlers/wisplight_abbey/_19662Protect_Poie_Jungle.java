...
/**
 * 微光修道院任务脚本：Protect Poie Jungle（任务 ID 19662）。
 * Wisplight Abbey quest script: Protect Poie Jungle (quest ID 19662).
 *
 * @author Rinzler (Encom)
 */
public class _19662Protect_Poie_Jungle extends QuestHandler {

	private final static int questId = 19662;
	private final static int[] mobs = {211879, 211880, 211885, 211886};
