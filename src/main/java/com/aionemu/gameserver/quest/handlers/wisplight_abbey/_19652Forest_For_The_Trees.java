...
/**
 * 微光修道院任务脚本：Forest For The Trees（任务 ID 19652）。
 * Wisplight Abbey quest script: Forest For The Trees (quest ID 19652).
 *
 * @author Rinzler (Encom)
 */
public class _19652Forest_For_The_Trees extends QuestHandler {

	private final static int questId = 19652;
	private final static int[] mobs = {210188, 210189, 210193};
