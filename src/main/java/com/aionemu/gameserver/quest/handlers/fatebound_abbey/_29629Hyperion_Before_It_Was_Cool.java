...
/**
 * 命运修道院任务脚本：Hyperion Before It Was Cool（任务 ID 29629）。
 * Fatebound Abbey quest script: Hyperion Before It Was Cool (quest ID 29629).
 *
 * @author Rinzler (Encom)
 */
public class _29629Hyperion_Before_It_Was_Cool extends QuestHandler {

	private final static int questId = 29629;
