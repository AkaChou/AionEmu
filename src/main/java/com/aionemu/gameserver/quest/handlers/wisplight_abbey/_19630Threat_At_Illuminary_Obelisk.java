...
/**
 * 微光修道院任务脚本：Threat At Illuminary Obelisk（任务 ID 19630）。
 * Wisplight Abbey quest script: Threat At Illuminary Obelisk (quest ID 19630).
 *
 * @author Rinzler (Encom)
 */
public class _19630Threat_At_Illuminary_Obelisk extends QuestHandler {

	private final static int questId = 19630;
