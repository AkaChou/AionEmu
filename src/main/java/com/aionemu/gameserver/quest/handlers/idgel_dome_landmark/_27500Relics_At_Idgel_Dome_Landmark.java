package com.aionemu.gameserver.quest.handlers.idgel_dome_landmark;
...
/**
 * 伊德格尔穹顶地标任务脚本：Relics At Idgel Dome Landmark（任务 ID 27500）。
 * Idgel Dome Landmark quest script: Relics At Idgel Dome Landmark (quest ID 27500).
 *
...
public class _27500Relics_At_Idgel_Dome_Landmark extends QuestHandler {
	...
	public void register() {
		qe.registerQuestNpc(806264).addOnQuestStart(questId); //?.
		qe.registerQuestNpc(806264).addOnTalkEvent(questId); //?.
		qe.registerQuestNpc(806265).addOnTalkEvent(questId); //???.
