...
/**
 * 制作任务脚本：Master Constructors Potential（任务 ID 19057）。
 * Crafting quest script: Master Constructors Potential (quest ID 19057).
 *
 * @author Ritsu
 */
