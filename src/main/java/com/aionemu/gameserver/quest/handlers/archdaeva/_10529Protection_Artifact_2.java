...
/**
 * 大天使任务脚本：Protection Artifact 2（任务 ID 10529）。
 * Archdaeva quest script: Protection Artifact 2 (quest ID 10529).
 *
 * @author (Encom)
 */
                    ...
                    case USE_OBJECT: {
                        if (var == 7) {
							...
							GameThreadPoolServices.threadPoolManager().schedule(new Runnable() {
								@Override
								public void run() {
									QuestService.addNewSpawn(301690000, player.getInstanceId(), 244113, (float) 172.000, (float) 156.000, (float) 230.53053, (byte) 96); //.
									QuestService.addNewSpawn(301690000, player.getInstanceId(), 806294, (float) 173.08958, (float) 153.30316, (float) 230.3820, (byte) 67); // ??.
								}
							}, 30000);
							return closeDialogWindow(env);
                        }
