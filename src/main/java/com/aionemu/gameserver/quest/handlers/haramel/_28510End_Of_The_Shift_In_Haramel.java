package com.aionemu.gameserver.quest.handlers.haramel;
...
/**
 * 哈拉梅尔任务脚本：End Of The Shift In Haramel（任务 ID 28510）。
 * Haramel quest script: End Of The Shift In Haramel (quest ID 28510). Remake Rinzler (Encom) /***
 */
