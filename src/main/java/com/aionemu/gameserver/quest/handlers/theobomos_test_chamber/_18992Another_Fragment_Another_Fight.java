package com.aionemu.gameserver.quest.handlers.theobomos_test_chamber;
...
/**
 * 西奥博莫斯试验室任务脚本：Another Fragment Another Fight（任务 ID 18992）。
 * Theobomos Test Chamber quest script: Another Fragment Another Fight (quest ID 18992).
 *
