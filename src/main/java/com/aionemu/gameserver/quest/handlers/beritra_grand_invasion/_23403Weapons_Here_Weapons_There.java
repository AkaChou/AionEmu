package com.aionemu.gameserver.quest.handlers.beritra_grand_invasion;
...
/**
 * 贝里特拉大入侵任务脚本：Weapons Here Weapons There（任务 ID 23403）。
 * Beritra Grand Invasion quest script: Weapons Here Weapons There (quest ID 23403).
 *
