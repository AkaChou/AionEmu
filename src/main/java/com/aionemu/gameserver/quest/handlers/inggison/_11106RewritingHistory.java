...
/**
 * 因吉森任务脚本：Rewriting History（任务 ID 11106）。
 * Inggison quest script: Rewriting History (quest ID 11106).
 *
 * @author Leunam
 */
		...
		if (qs == null || qs.getStatus() == QuestStatus.NONE) {
		    if (targetId == 798976) {
				if (env.getDialog() == QuestDialog.START_DIALOG)
					...
					return sendQuestStartDialog(env, 182206780, 1);
				}
			}
		}
		if (qs == null)
