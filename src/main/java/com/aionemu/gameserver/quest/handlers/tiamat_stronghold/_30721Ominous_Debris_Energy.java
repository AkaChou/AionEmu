...
public class _30721Ominous_Debris_Energy extends QuestHandler {

	private static final int questId = 30721;

	public _30721Ominous_Debris_Energy() {
		super(questId);
	}
	...
	public void register() {
		...
		qe.registerQuestNpc(804868).addOnTalkEvent(questId);
		qe.registerQuestItem(182215698, questId);
	}

	@Override
	public boolean onDialogEvent(QuestEnv env) {
		return handleDialog(env, 804704, 804870, 804868);
	}

	private boolean handleDialog(QuestEnv env, int startNpcId, int firstNpcId, int secondNpcId) {
		...
		} else if (qs.getStatus() == QuestStatus.REWARD && targetId == firstNpcId) {
	...
	public HandlerResult onItemUseEvent(QuestEnv env, Item item) {
		...
		if (qs == null || qs.getStatus() != QuestStatus.START || qs.getQuestVarById(0) != 2
				|| !player.isInsideZone(ZoneName.get("LF5_ITEMUSEAREA_Q30721"))) {
