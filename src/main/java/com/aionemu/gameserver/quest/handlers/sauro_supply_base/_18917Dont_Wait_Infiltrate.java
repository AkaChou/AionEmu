package com.aionemu.gameserver.quest.handlers.sauro_supply_base;
...
/**
 * 索罗补给基地任务脚本：Dont Wait Infiltrate（任务 ID 18917）。
 * Sauro Supply Base quest script: Dont Wait Infiltrate (quest ID 18917).
 *
