...
/**
 * 贝勒斯兰任务脚本：The Ancient Book（任务 ID 2670）。
 * Beluslan quest script: The Ancient Book (quest ID 2670).
 */
public class _2670The_Ancient_Book extends QuestHandler {
	...
	public boolean onDialogEvent(QuestEnv env) {
		...
		} else if (qs == null || qs.getStatus() == QuestStatus.REWARD && targetId == 204208) {
			return sendQuestEndDialog(env);
		}
		return false;
	}
