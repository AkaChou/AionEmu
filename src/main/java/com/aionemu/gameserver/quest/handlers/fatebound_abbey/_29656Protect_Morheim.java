...
/**
 * 命运修道院任务脚本：Protect Morheim（任务 ID 29656）。
 * Fatebound Abbey quest script: Protect Morheim (quest ID 29656).
 *
 * @author Rinzler (Encom)
 */
public class _29656Protect_Morheim extends QuestHandler {

	private final static int questId = 29656;
	private final static int[] mobs = {211297, 211298, 211304, 211305};
