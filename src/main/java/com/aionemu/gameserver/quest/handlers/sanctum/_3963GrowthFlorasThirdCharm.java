...
/**
 * 圣所任务脚本：Growth Floras Third Charm（任务 ID 3963）。
 * Sanctum quest script: Growth Floras Third Charm (quest ID 3963). Talk with Erdos (203740). Bring the Red Aether Powder (186000089) and Kinah (70000) to Flora (798384).
 *
 * @author undertrey
 * @modified vlog
 */
				...
				case 798384: // Flora
					switch (env.getDialog()) {
						...
						case CHECK_COLLECTED_ITEMS:
							if (var == 1 && player.getInventory().getItemCountByItemId(186000089) == 1) {
