package com.aionemu.gameserver.quest.handlers.radiant_ops;
...
/**
 * 光辉行动任务脚本：Radiant Ops Recruitment（任务 ID 38001）。
 * Radiant Ops quest script: Radiant Ops Recruitment (quest ID 38001).
 *
 * @author vlog
 */
