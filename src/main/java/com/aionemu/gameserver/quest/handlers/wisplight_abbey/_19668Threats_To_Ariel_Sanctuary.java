...
/**
 * 微光修道院任务脚本：Threats To Ariel Sanctuary（任务 ID 19668）。
 * Wisplight Abbey quest script: Threats To Ariel Sanctuary (quest ID 19668).
 *
 * @author Rinzler (Encom)
 */
public class _19668Threats_To_Ariel_Sanctuary extends QuestHandler {

	private final static int questId = 19668;
