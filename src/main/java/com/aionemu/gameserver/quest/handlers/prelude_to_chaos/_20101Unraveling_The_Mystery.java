package com.aionemu.gameserver.quest.handlers.prelude_to_chaos;
...
/**
 * 混沌序章任务脚本：Unraveling The Mystery（任务 ID 20101）。
 * Prelude to Chaos quest script: Unraveling The Mystery (quest ID 20101).
 *
