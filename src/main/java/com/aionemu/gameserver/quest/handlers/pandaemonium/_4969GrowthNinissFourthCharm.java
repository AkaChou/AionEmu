...
/**
 * 潘德莫尼姆任务脚本：Growth Niniss Fourth Charm（任务 ID 4969）。
 * Pandaemonium quest script: Growth Niniss Fourth Charm (quest ID 4969). Talk with Maochinicherk (798068). Bring the Brilliant Aether Paper (186000093) and Kinah (90000) to Ninis (798385).
 *
 * @author undertrey
 * @modified vlog
 */
				...
				case 798385: // Ninis
					switch (env.getDialog()) {
						...
						case CHECK_COLLECTED_ITEMS:
							if (var == 1 && player.getInventory().getItemCountByItemId(186000093) == 1) {
