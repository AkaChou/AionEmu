...
/**
 * 因吉森任务脚本：A Risk For The Obelisk（任务 ID 10031）。
 * Inggison quest script: A Risk For The Obelisk (quest ID 10031).
 *
            ...
            if (targetId == 203700) {
                ...
                switch (env.getDialog()) {
                    case START_DIALOG: {
						...
						updateQuestStatus(env);
						TeleportService2.teleportTo(player, 210050000, 1320.3668f, 253.15457f, 591.18146f, (byte) 77);
						return true;
					}
                }
