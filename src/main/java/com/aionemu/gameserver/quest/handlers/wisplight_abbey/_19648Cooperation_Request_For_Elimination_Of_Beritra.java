...
/**
 * 微光修道院任务脚本：Cooperation Request For Elimination Of Beritra（任务 ID 19648）。
 * Wisplight Abbey quest script: Cooperation Request For Elimination Of Beritra (quest ID 19648).
 *
 * @author Rinzler (Encom)
 */
public class _19648Cooperation_Request_For_Elimination_Of_Beritra extends QuestHandler {

	private final static int questId = 19648;
