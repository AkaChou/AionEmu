...
/**
 * 命运修道院任务脚本：Protect Impetusium（任务 ID 29653）。
 * Fatebound Abbey quest script: Protect Impetusium (quest ID 29653).
 *
 * @author Rinzler (Encom)
 */
public class _29653Protect_Impetusium extends QuestHandler {

	private final static int questId = 29653;
	private final static int[] mobs = {210575, 210576};
