...
/**
 * 命运修道院任务脚本：Protect The Salt Desert（任务 ID 29657）。
 * Fatebound Abbey quest script: Protect The Salt Desert (quest ID 29657).
 *
 * @author Rinzler (Encom)
 */
public class _29657Protect_The_Salt_Desert extends QuestHandler {

	private final static int questId = 29657;
	private final static int[] mobs = {212396, 212397, 211357, 211379};
