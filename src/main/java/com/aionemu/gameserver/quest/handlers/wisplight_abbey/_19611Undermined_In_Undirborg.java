...
/**
 * 微光修道院任务脚本：Undermined In Undirborg（任务 ID 19611）。
 * Wisplight Abbey quest script: Undermined In Undirborg (quest ID 19611).
 *
 * @author Rinzler (Encom)
 */
public class _19611Undermined_In_Undirborg extends QuestHandler {

	private final static int questId = 19611;
