...
/**
 * 微光修道院任务脚本：Still More In Levinshor（任务 ID 19623）。
 * Wisplight Abbey quest script: Still More In Levinshor (quest ID 19623).
 *
 * @author Rinzler (Encom)
 */
public class _19623Still_More_In_Levinshor extends QuestHandler {

	private final static int questId = 19623;
