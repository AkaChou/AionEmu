...
/**
 * 潘德莫尼姆任务脚本：Growth Niniss Third Charm（任务 ID 4968）。
 * Pandaemonium quest script: Growth Niniss Third Charm (quest ID 4968). Talk with Maochinicherk (798068). Bring the Glowing Aether Paper (186000092) and Kinah (70000) to Ninis (798385).
 *
 * @author undertrey
 * @modified vlog
 */
				...
				case 798385: // Ninis
					switch (env.getDialog()) {
						...
						case CHECK_COLLECTED_ITEMS:
							if (var == 1 && player.getInventory().getItemCountByItemId(186000092) == 1) {
                                player.getInventory().tryDecreaseKinah(70000);
