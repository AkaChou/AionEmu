...
/**
 * 圣所任务脚本：Growth Floras Second Charm（任务 ID 3962）。
 * Sanctum quest script: Growth Floras Second Charm (quest ID 3962). Talk with Erdos (203740). Bring the Blue Aether Powder (186000088) and Kinah (50000) to Flora (798384).
 *
 * @author undertrey
 * @modified vlog
 */
				...
				case 798384: // Flora
					switch (env.getDialog()) {
						...
						case CHECK_COLLECTED_ITEMS:
							if (var == 1 && player.getInventory().getItemCountByItemId(186000088) == 1) {
