...
/**
 * 伊卢玛任务脚本：The Hall Of Zephyr（任务 ID 15606）。
 * Iluma quest script: The Hall Of Zephyr (quest ID 15606).
 *
				...
				switch (env.getDialog()) {
                    case START_DIALOG: {
						...
						if (QuestService.collectItemCheck(env, true)) {
							removeQuestItem(env, 182215996, 1); //?? ?  ?.
