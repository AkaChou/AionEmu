...
/**
 * 先驱者登陆点任务脚本：Handle Frozen Armor Magical Weapon Deplodox（任务 ID 25410）。
 * Harbinger Landing quest script: Handle Frozen Armor Magical Weapon Deplodox (quest ID 25410).
 *
