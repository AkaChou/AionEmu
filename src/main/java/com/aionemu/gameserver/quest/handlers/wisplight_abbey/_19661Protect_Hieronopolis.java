...
/**
 * 微光修道院任务脚本：Protect Hieronopolis（任务 ID 19661）。
 * Wisplight Abbey quest script: Protect Hieronopolis (quest ID 19661).
 *
 * @author Rinzler (Encom)
 */
public class _19661Protect_Hieronopolis extends QuestHandler {

	private final static int questId = 19661;
	private final static int[] mobs = {211049, 211869, 211870};
