...
/**
 * 因吉森任务脚本：When The Time Is Ripe（任务 ID 11455）。
 * Inggison quest script: When The Time Is Ripe (quest ID 11455).
 *
		...
		if (qs == null || qs.getStatus() == QuestStatus.NONE) {
		    if (targetId == 799070) {
				if (env.getDialog() == QuestDialog.START_DIALOG)
					...
					return sendQuestStartDialog(env, 182209503, 1);
				}
			}
		} 
        if (qs == null)
