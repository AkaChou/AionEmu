...
/**
 * 命运修道院任务脚本：Threats To The Azphel Sanctuary（任务 ID 29668）。
 * Fatebound Abbey quest script: Threats To The Azphel Sanctuary (quest ID 29668).
 *
 * @author Rinzler (Encom)
 */
public class _29668Threats_To_The_Azphel_Sanctuary extends QuestHandler {

	private final static int questId = 29668;
