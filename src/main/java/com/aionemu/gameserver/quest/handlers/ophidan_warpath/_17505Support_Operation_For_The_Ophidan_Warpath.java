package com.aionemu.gameserver.quest.handlers.ophidan_warpath;
...
/**
 * 奥菲丹战径任务脚本：Support Operation For The Ophidan Warpath（任务 ID 17505）。
 * Ophidan Warpath quest script: Support Operation For The Ophidan Warpath (quest ID 17505).
 *
...
public class _17505Support_Operation_For_The_Ophidan_Warpath extends QuestHandler {
	...
	public void register() {
		...
		qe.registerQuestItem(182216067, questId); //?  .
		qe.registerQuestNpc(806266).addOnQuestStart(questId); //.
		qe.registerQuestNpc(806266).addOnTalkEvent(questId); //.
		qe.registerQuestNpc(806267).addOnTalkEvent(questId); //.
		qe.registerQuestNpc(806270).addOnTalkEvent(questId); //.
	...
	public HandlerResult onItemUseEvent(QuestEnv env, Item item) {
		...
		if (qs != null && qs.getQuestVarById(0) == 2) {
			removeQuestItem(env, 182216067, 1); //?  .
