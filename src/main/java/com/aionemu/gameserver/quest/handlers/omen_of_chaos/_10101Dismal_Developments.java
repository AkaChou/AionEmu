package com.aionemu.gameserver.quest.handlers.omen_of_chaos;
...
/**
 * 混沌预兆任务脚本：Dismal Developments（任务 ID 10101）。
 * Omen of Chaos quest script: Dismal Developments (quest ID 10101).
 *
