package com.aionemu.gameserver.quest.handlers.panesterra;
...
/**
 * 帕内斯特拉任务脚本：Welcome To Panesterra（任务 ID 24220）。
 * Panesterra quest script: Welcome To Panesterra (quest ID 24220).
 *
