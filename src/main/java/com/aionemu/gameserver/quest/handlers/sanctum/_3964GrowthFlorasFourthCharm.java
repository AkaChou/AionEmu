...
/**
 * 圣所任务脚本：Growth Floras Fourth Charm（任务 ID 3964）。
 * Sanctum quest script: Growth Floras Fourth Charm (quest ID 3964). Talk with Erdos (203740). Bring the Yellow Aether Powder (186000090) and Kinah (90000) to Flora (798384).
 *
 * @author undertrey
 * @modified vlog
 */
