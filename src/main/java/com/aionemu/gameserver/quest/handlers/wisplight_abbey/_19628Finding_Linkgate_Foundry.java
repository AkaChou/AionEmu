...
/**
 * 微光修道院任务脚本：Finding Linkgate Foundry（任务 ID 19628）。
 * Wisplight Abbey quest script: Finding Linkgate Foundry (quest ID 19628).
 *
 * @author Rinzler (Encom)
 */
public class _19628Finding_Linkgate_Foundry extends QuestHandler {

	private final static int questId = 19628;
