package com.aionemu.gameserver.quest.handlers.esoterrace;
...
/**
 * 异界平台任务脚本：Reclaiming Esoterrace（任务 ID 27541）。
 * Esoterrace quest script: Reclaiming Esoterrace (quest ID 27541).
 *
