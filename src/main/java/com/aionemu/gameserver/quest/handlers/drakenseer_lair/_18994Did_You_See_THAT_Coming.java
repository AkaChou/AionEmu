package com.aionemu.gameserver.quest.handlers.drakenseer_lair;
...
/**
 * 龙先知巢穴任务脚本：Did You See THAT Coming（任务 ID 18994）。
 * Drakenseer Lair quest script: Did You See THAT Coming (quest ID 18994).
 *
...
public class _18994Did_You_See_THAT_Coming extends QuestHandler {
	...
	private final static int[] IDF6DragonArtifactBoost = {857974,857975, 857976}; // ? ?? .
