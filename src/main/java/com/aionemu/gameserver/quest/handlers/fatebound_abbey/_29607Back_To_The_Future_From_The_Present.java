...
/**
 * 命运修道院任务脚本：Back To The Future From The Present（任务 ID 29607）。
 * Fatebound Abbey quest script: Back To The Future From The Present (quest ID 29607).
 *
 * @author Rinzler (Encom)
 */
public class _29607Back_To_The_Future_From_The_Present extends QuestHandler {

	private final static int questId = 29607;
