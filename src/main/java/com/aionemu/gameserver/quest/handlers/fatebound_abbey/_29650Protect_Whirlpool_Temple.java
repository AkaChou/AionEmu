...
/**
 * 命运修道院任务脚本：Protect Whirlpool Temple（任务 ID 29650）。
 * Fatebound Abbey quest script: Protect Whirlpool Temple (quest ID 29650).
 *
 * @author Rinzler (Encom)
 */
public class _29650Protect_Whirlpool_Temple extends QuestHandler {

	private final static int questId = 29650;
	private final static int[] mobs = {219750, 219758, 219759};
