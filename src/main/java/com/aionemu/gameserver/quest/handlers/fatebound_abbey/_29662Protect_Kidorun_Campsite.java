...
/**
 * 命运修道院任务脚本：Protect Kidorun Campsite（任务 ID 29662）。
 * Fatebound Abbey quest script: Protect Kidorun Campsite (quest ID 29662).
 *
 * @author Rinzler (Encom)
 */
public class _29662Protect_Kidorun_Campsite extends QuestHandler {

	private final static int questId = 29662;
	private final static int[] mobs = {213263, 213264, 213278, 213279};
