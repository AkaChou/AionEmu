...
/**
 * 潘德莫尼姆任务脚本：Growth Niniss First Charm（任务 ID 4966）。
 * Pandaemonium quest script: Growth Niniss First Charm (quest ID 4966). Talk with Maochinicherk (798068). Bring some Kinah to Ninis (798385).
 *
 * @author undertrey
 * @modified vlog
 */
