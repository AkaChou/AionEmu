...
public class PetSkillData {
	...
	private final IntObjectHashMap<IntIntHashMap> petSkillData = new IntObjectHashMap<>();

	/** 宠物 NPC ID → 技能 ID 列表 / pet npc id → skill id list */
	private final IntObjectHashMap<IntArrayList> petSkillsMap = new IntObjectHashMap<>();
