...
public class TowerRewardData {
	...
	@XmlTransient
	private final IntObjectHashMap<TowerStageRewardTemplate> templates = new IntObjectHashMap<>();

	@XmlTransient
	private final Map<Integer, TowerStageRewardTemplate> templatesMap = new HashMap<>();
