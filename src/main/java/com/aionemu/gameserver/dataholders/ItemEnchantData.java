...
public class ItemEnchantData {
	...
	@XmlTransient
	private final IntObjectHashMap<ItemEnchantTemplate> enchants = new IntObjectHashMap<>();

	@XmlTransient
	private final IntObjectHashMap<ItemEnchantTemplate> authorizes = new IntObjectHashMap<>();
