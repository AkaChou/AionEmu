...
public class ChargeSkillData {
	...
	private final IntObjectHashMap<ChargeSkillTemplate> ids = new IntObjectHashMap<>();
	private final Map<String, ChargeSkillTemplate> setName = new LinkedHashMap<>();
	private final IntObjectHashMap<ChargeSkillTemplate> firstTemplates = new IntObjectHashMap<>();
	private final IntObjectHashMap<ChargeSkillTemplate> totalTemplates = new IntObjectHashMap<>();
