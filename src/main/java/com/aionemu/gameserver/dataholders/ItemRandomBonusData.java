...
public class ItemRandomBonusData {
	...
	@XmlTransient
	private final IntObjectHashMap<RandomBonus> inventoryRandomBonusData = new IntObjectHashMap<>();

	@XmlTransient
	private final IntObjectHashMap<RandomBonus> polishRandomBonusData = new IntObjectHashMap<>();
