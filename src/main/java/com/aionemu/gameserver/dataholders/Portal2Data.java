...
public class Portal2Data {
	...
	@XmlTransient
	private final IntObjectHashMap<PortalUse> portalUses = new IntObjectHashMap<>();

	@XmlTransient
	private final IntObjectHashMap<PortalDialog> portalDialogs = new IntObjectHashMap<>();
