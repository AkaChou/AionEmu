...
public class AutoGroupData {
	...
	@XmlTransient
	private final IntObjectHashMap<AutoGroup> autoGroupByInstanceId = new IntObjectHashMap<>();
	@XmlTransient
	private final IntObjectHashMap<AutoGroup> autoGroupByNpcId = new IntObjectHashMap<>();
