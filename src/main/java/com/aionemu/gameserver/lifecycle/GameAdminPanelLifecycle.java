...
/**
 * 管理面板生命周期：在启动序列中触发 gateway 并记录加载状态。
 * Lifecycle for admin panel: drives the gateway during startup and tracks load state.
 */
@Component
...
public class GameAdminPanelLifecycle {
    ...
    /**
     * 启动本阶段：若启用则启动管理面板。
     * Start this stage: start the admin panel when enabled.
     */
