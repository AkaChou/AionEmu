...
/**
 * 日志初始化生命周期：在启动序列中触发 gateway 并记录加载状态。
 * Lifecycle for logging: drives the gateway during startup and tracks load state.
 */
@Component
...
public class GameLoggingLifecycle {
    ...
    /**
     * 启动本阶段：初始化日志系统。
     * Start this stage: initialize the logging system.
     */
