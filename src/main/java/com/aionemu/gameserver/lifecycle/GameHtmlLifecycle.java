...
/**
 * HTML 生命周期：在启动序列中触发 gateway 并记录加载状态。
 * Lifecycle for HTML: drives the gateway during startup and tracks load state.
 */
@Component
...
public class GameHtmlLifecycle {
     ...
     * HTML gateway.
     */
    private final GameHtmlGateway htmlGateway;
    ...
    /**
     * 启动本阶段：初始化 HTML 缓存。
     * Start this stage: initialize the HTML cache.
     */
