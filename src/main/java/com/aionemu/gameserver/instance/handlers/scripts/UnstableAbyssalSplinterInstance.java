		...
		switch (npc.getObjectTemplate().getTemplateId()) {
			...
			case 219552: //Unstable Ebonsoul.
			    ...
			    if (isDead(unstableRukril) && isDead(unstableEbonsoul)) {
		            ...
		            spawn(701576, 408.10938f, 650.9015f, 439.28332f, (byte) 66); // 创世宝箱 / Genesis Treasure Box
		            spawn(701576, 402.40375f, 655.55237f, 439.26288f, (byte) 33); // 创世宝箱 / Genesis Treasure Box
		            spawn(701576, 406.74445f, 655.5914f, 439.2548f, (byte) 100); // 创世宝箱 / Genesis Treasure Box
			...
			case 219553: //Unstable Kaluva The Fourth.
				...
				// 出现了一个宝箱。 / A treasure chest has appeared.
				sendMsgByRace(1400636, Race.PC_ALL, 3000);
		        spawn(701576, 601.2931f, 584.66705f, 422.9955f, (byte) 6); // 创世宝箱 / Genesis Treasure Box
		        spawn(701576, 597.2156f, 583.95416f, 423.3474f, (byte) 66); // 创世宝箱 / Genesis Treasure Box
		        spawn(701576, 602.9586f, 589.2678f, 422.8296f, (byte) 100); // 创世宝箱 / Genesis Treasure Box
			...
			case 219554: //Unstable Pazuzu.
		        ...
		        spawn(701576, 651.53204f, 357.085f, 466.1315f, (byte) 66); // 创世宝箱 / Genesis Treasure Box
		        spawn(701576, 647.00446f, 357.2484f, 465.8960f, (byte) 0); // 创世宝箱 / Genesis Treasure Box
		        spawn(701576, 653.8384f, 360.39508f, 466.4391f, (byte) 100); // 创世宝箱 / Genesis Treasure Box
				sp(700955, npc.getX(), npc.getY(), npc.getZ(), (byte) 0, 3000, 0, null); //Huge Aether Fragment.
			break;
