...
public class CradleOfEternityInstance extends GeneralInstanceHandler
{
		...
		switch (npc.getNpcId()) {
			...
			case 703025: //Heavy Door Lever.
				...
				ThreadPoolManager.getInstance().schedule(new Runnable() {
					...
					public void run() {
						deleteNpc(703026);
						//Youve removed the pollutants from the library.
						sendMsgByRace(1403526, Race.PC_ALL, 0);
						//The librarys pollutants have disappeared.
			    ...
			    if (player.getInventory().decreaseByItemId(185000267, 1)) { //Sun Quartz.
					ThreadPoolManager.getInstance().schedule(new Runnable() {
						...
						public void run() {
							...
							//Youve discovered a hidden entrance.
					...
					//You dont have a Rose Quarz of Sun to place on the altar.
    ...
    public void onEnterZone(Player player, ZoneInstance zone) {
		if (zone.getAreaTemplate().getZoneName() == ZoneName.get("HOLLOW_TEMPLE_301550000")) {
            //Youve discovered the Altar of Emptiness.
            ...
            //Youve discovered the Altar of Earth.
            ...
            //Youve discovered the entrance to Vids Secret Library.
            ...
            //Youve discovered the Altar of Sun.
			//Looks like you could place something on it.
			sendMsgByRace(1403521, Race.PC_ALL, 0);
			//Youve discovered a strange Kisk.
	...
	private void removeEffects(Player player) {
		...
		//The Sylfae Queens power has disappeared.
