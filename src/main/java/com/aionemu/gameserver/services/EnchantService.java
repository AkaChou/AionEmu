...
public class EnchantService {
	 ...
	 */
		...
		if (result) {
			...
			if (targetItem.isArchDaevaItem() && targetItem.isEquipped() && !EnchantItemRules.isArchdaevaReformedDanuar(targetItem)
				&& !EnchantItemRules.isArchdaevaRemodeledDanuar(targetItem) && !EnchantItemRules.isArchdaevaRestructuredDanuar(targetItem)
				&& !EnchantItemRules.isGrayWolfAccessories(targetItem) && !EnchantItemRules.isEnhancedAncientFallusha(targetItem)) {
	...
	public static boolean isEnhancedAncientFallusha(Item targetItem) {
		return EnchantItemRules.isEnhancedAncientFallusha(targetItem);
	}


	public static boolean isGrayWolfAccessories(Item targetItem) {
		return EnchantItemRules.isGrayWolfAccessories(targetItem);
	}


	public static boolean isArchdaevaReformedDanuar(Item targetItem) {
		return EnchantItemRules.isArchdaevaReformedDanuar(targetItem);
	}


	public static boolean isArchdaevaRemodeledDanuar(Item targetItem) {
		return EnchantItemRules.isArchdaevaRemodeledDanuar(targetItem);
	}


	public static boolean isArchdaevaRestructuredDanuar(Item targetItem) {
		return EnchantItemRules.isArchdaevaRestructuredDanuar(targetItem);
	}


	public static void GloryShieldSkill(Player player) {
		EnchantItemRules.GloryShieldSkill(player);
	}
