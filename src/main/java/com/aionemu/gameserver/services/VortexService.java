		...
		case 1:
			com.aionemu.gameserver.lifecycle.GameWorldBootstrapServices.world().doOnAllPlayers(new Visitor<Player>() {
				...
				public void visit(Player player) {
					...
					// will be disbanded and all infiltrators will be returned home.
					PacketSendUtility.playerSendPacketTime(player,
							SM_SYSTEM_MESSAGE.STR_MSG_INVADE_DIRECT_PORTAL_CLOSE_TIMER_90M, 1800000);
					// The Dimensional Vortex will close in 60 minutes. When it closes, the alliance
					// will be disbanded and all infiltrators will be returned home.
					PacketSendUtility.playerSendPacketTime(player,
							SM_SYSTEM_MESSAGE.STR_MSG_INVADE_DIRECT_PORTAL_CLOSE_TIMER_60M, 3600000);
					// The Dimensional Vortex will close in 30 minutes. When it closes, the alliance
					// will be disbanded and all infiltrators will be returned home.
					PacketSendUtility.playerSendPacketTime(player,
							SM_SYSTEM_MESSAGE.STR_MSG_INVADE_DIRECT_PORTAL_CLOSE_TIMER_30M, 5400000);
					// The Dimensional Vortex will close in 15 minutes. When it closes, the alliance
					// will be disbanded and all infiltrators will be returned home.
					PacketSendUtility.playerSendPacketTime(player,
							SM_SYSTEM_MESSAGE.STR_MSG_INVADE_DIRECT_PORTAL_CLOSE_TIMER_15M, 6300000);
					// The Dimensional Vortex will close in 10 minutes. When it closes, the alliance
					// will be disbanded and all infiltrators will be returned home.
					PacketSendUtility.playerSendPacketTime(player,
							SM_SYSTEM_MESSAGE.STR_MSG_INVADE_DIRECT_PORTAL_CLOSE_TIMER_10M, 6600000);
					// The Dimensional Vortex will close in 5 minutes. When it closes, the alliance
					// will be disbanded and all infiltrators will be returned home.
					PacketSendUtility.playerSendPacketTime(player,
							SM_SYSTEM_MESSAGE.STR_MSG_INVADE_DIRECT_PORTAL_CLOSE_TIMER_5M, 6900000);
					// The Dimensional Vortex will close in 3 minutes. When it closes, the alliance
					// will be disbanded and all infiltrators will be returned home.
					PacketSendUtility.playerSendPacketTime(player,
							SM_SYSTEM_MESSAGE.STR_MSG_INVADE_DIRECT_PORTAL_CLOSE_TIMER_3M, 7020000);
					// The Dimensional Vortex will close in 2 minutes. When it closes, the alliance
					// will be disbanded and all infiltrators will be returned home.
					PacketSendUtility.playerSendPacketTime(player,
							SM_SYSTEM_MESSAGE.STR_MSG_INVADE_DIRECT_PORTAL_CLOSE_TIMER_2M, 7080000);
					// The Dimensional Vortex will close in 1 minutes. When it closes, the alliance
					// will be disbanded and all infiltrators will be returned home.
					PacketSendUtility.playerSendPacketTime(player,
							SM_SYSTEM_MESSAGE.STR_MSG_INVADE_DIRECT_PORTAL_CLOSE_TIMER_1M, 7140000);
					// The Dimensional Vortex has closed, and you will be returned to where you
					// entered.
					PacketSendUtility.playerSendPacketTime(player,
