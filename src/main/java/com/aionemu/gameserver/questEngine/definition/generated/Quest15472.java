...
public final class Quest15472 {
	private Quest15472() {}

	public static CompiledQuestDefinition definition() {
		QuestDsl.QuestBuilder builder = QuestDsl.quest(15472)
			.version(1)
			.metadata(metadata());
	...
	private static void addTransition29(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.KillNpcSet(Set.of(883012, 882988, 883010, 882986, 883120, 882998, 883142, 883000, 883144, 883096, 883094, 883118))).from("started").goTo("reward");
		builder.afterCommit(new AfterCommitAction.SyncQuestState(QuestStateSyncMode.PACKET_ONLY));
	}
}
