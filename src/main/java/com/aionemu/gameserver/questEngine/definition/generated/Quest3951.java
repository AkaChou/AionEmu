...
public final class Quest3951 {
	private Quest3951() {}

	public static CompiledQuestDefinition definition() {
		QuestDsl.QuestBuilder builder = QuestDsl.quest(3951)
			.version(1)
			.metadata(metadata());
	...
	private static QuestMetadata metadata() {
		return new QuestMetadata("[Expert] Cook's Craft", 1103072, 29, 2147483647, Set.of("ELYOS"), "SIGNIFICANT", new RepeatPolicy(1, 0L, false, false), Set.of(), List.of(new QuestItemRequirement(182206902, 1), new QuestItemRequirement(182206903, 1), new QuestItemRequirement(182206904, 1), new QuestItemRequirement(182206905, 1)), List.of(new QuestReward("EXP", 0, 291412L)), List.of(), Set.of(), "", 0, 1, 1, true, false, false, 0, null, null, false, Set.of(), 0, "NONE", "NONE", 0, List.of(), List.of(), List.of(), List.of(), List.of(), List.of(new QuestStartCondition("finished", 3950, 0)), Map.of());
	}
	...
	private static void addTransition10(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.TalkToNpc(203784, 39, 0)).from("started").priority(0).when(new QuestCondition.HasItem(182206902, 1, true)).when(new QuestCondition.HasItem(182206903, 1, true)).when(new QuestCondition.HasItem(182206904, 1, true)).when(new QuestCondition.HasItem(182206905, 1, true)).then(new QuestAction.RemoveItem(182206902, 1)).then(new QuestAction.RemoveItem(182206903, 1)).then(new QuestAction.RemoveItem(182206904, 1)).then(new QuestAction.RemoveItem(182206905, 1)).goTo("reward");
	...
	private static void addTransition12(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.TalkToNpc(203784, 20002, 0)).from("started").priority(0).when(new QuestCondition.HasItem(182206902, 1, true)).when(new QuestCondition.HasItem(182206903, 1, true)).when(new QuestCondition.HasItem(182206904, 1, true)).when(new QuestCondition.HasItem(182206905, 1, true)).then(new QuestAction.RemoveItem(182206902, 1)).then(new QuestAction.RemoveItem(182206903, 1)).then(new QuestAction.RemoveItem(182206904, 1)).then(new QuestAction.RemoveItem(182206905, 1)).goTo("reward");
		builder.afterCommit(new AfterCommitAction.SyncQuestState(QuestStateSyncMode.PACKET_ONLY));
		builder.afterCommit(new AfterCommitAction.ShowQuestDialog(5));
	}
