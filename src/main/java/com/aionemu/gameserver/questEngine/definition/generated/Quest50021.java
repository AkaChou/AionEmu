...
public final class Quest50021 {
	private Quest50021() {}

	public static CompiledQuestDefinition definition() {
		QuestDsl.QuestBuilder builder = QuestDsl.quest(50021)
			.version(1)
			.metadata(metadata());
	...
	private static QuestMetadata metadata() {
		return new QuestMetadata("[Event/Daily] Candygeddon", 1150064, 9, 2147483647, Set.of("ELYOS"), "EVENT", new RepeatPolicy(255, 0L, true, false), Set.of(50010), List.of(new QuestItemRequirement(182215176, 3)), List.of(new QuestReward("ITEM", 188051771, 1L), new QuestReward("ITEM", 160010212, 1L), new QuestReward("ITEM", 160010213, 1L)), List.of(new QuestDrop(701470, 182215176, 100, true, 4, QuestDropScope.GROUP)), Set.of(), "", 0, 1, 1, true, false, false, 0, null, null, false, Set.of("ALL"), 0, "NONE", "NONE", 0, List.of(), List.of(), List.of(), List.of(), List.of(), List.of(), Map.of());
	}
	...
	private static void addTransition2(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.TalkToNpc(202549, 1002, 0)).from("unaccepted").when(new QuestCondition.StartEligible()).goTo("a0");
		builder.afterCommit(new AfterCommitAction.SyncQuestState(QuestStateSyncMode.VISIBILITY_REFRESH));
		builder.afterCommit(new AfterCommitAction.ShowQuestDialog(1003));
	}

	private static void addTransition3(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.TalkToNpc(202549, 20000, 0)).from("unaccepted").when(new QuestCondition.StartEligible()).goTo("a0");
		builder.afterCommit(new AfterCommitAction.SyncQuestState(QuestStateSyncMode.VISIBILITY_REFRESH));
	...
	private static void addTransition11(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.TalkToNpc(202549, 31, 0)).from("a3").goTo("a3");
		builder.afterCommit(new AfterCommitAction.ShowQuestDialog(1352));
	}

	private static void addTransition12(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.TalkToNpc(202549, 1009, 0)).from("a3").goTo("reward");
		builder.afterCommit(new AfterCommitAction.SyncQuestState(QuestStateSyncMode.PACKET_ONLY));
