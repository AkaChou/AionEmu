...
public final class Quest18501 {
	private Quest18501() {}

	public static CompiledQuestDefinition definition() {
		QuestDsl.QuestBuilder builder = QuestDsl.quest(18501)
			.version(1)
			.metadata(metadata());
	...
	private static QuestMetadata metadata() {
		return new QuestMetadata("Shugo Indemnity", 1135001, 16, 2147483647, Set.of("ELYOS"), "IMPORTANT", new RepeatPolicy(1, 0L, false, false), Set.of(), List.of(new QuestItemRequirement(182212001, 5), new QuestItemRequirement(182212002, 5)), List.of(new QuestReward("GOLD", 0, 10150L), new QuestReward("EXP", 0, 75359L), new QuestReward("ITEM", 162000048, 20L), new QuestReward("ITEM", 169000005, 200L)), List.of(new QuestDrop(700833, 182212001, 100, true, 0, QuestDropScope.GROUP), new QuestDrop(700951, 182212002, 100, true, 0, QuestDropScope.GROUP)), Set.of(), "", 0, 1, 1, true, false, false, 0, null, null, false, Set.of(), 0, "NONE", "NONE", 0, List.of(), List.of(), List.of(), List.of(), List.of(), List.of(), Map.of());
	}
	...
	private static void addTransition10(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.TalkToNpc(799522, 39, 0)).from("started").priority(0).when(new QuestCondition.HasItem(182212001, 5, true)).when(new QuestCondition.HasItem(182212002, 5, true)).then(new QuestAction.RemoveItem(182212001, 5)).then(new QuestAction.RemoveItem(182212002, 5)).goTo("reward");
	...
	private static void addTransition12(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.TalkToNpc(799522, 20002, 0)).from("started").priority(0).when(new QuestCondition.HasItem(182212001, 5, true)).when(new QuestCondition.HasItem(182212002, 5, true)).then(new QuestAction.RemoveItem(182212001, 5)).then(new QuestAction.RemoveItem(182212002, 5)).goTo("reward");
		builder.afterCommit(new AfterCommitAction.SyncQuestState(QuestStateSyncMode.PACKET_ONLY));
		builder.afterCommit(new AfterCommitAction.ShowQuestDialog(5));
	}
