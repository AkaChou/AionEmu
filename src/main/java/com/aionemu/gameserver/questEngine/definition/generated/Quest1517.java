...
public final class Quest1517 {
	private Quest1517() {}

	public static CompiledQuestDefinition definition() {
		QuestDsl.QuestBuilder builder = QuestDsl.quest(1517)
			.version(1)
			.metadata(metadata());
	...
	private static QuestMetadata metadata() {
		return new QuestMetadata("[Group] Negating Nagas", 1102717, 46, 2147483647, Set.of("ELYOS"), "QUEST", new RepeatPolicy(1, 0L, false, false), Set.of(14054, 1062), List.of(), List.of(new QuestReward("GOLD", 0, 38500L), new QuestReward("EXP", 0, 2719217L), new QuestReward("RANDOM", 10005, 1L), new QuestReward("ITEM", 186000005, 1L), new QuestReward("ITEM", 188050838, 1L), new QuestReward("SELECTABLE_ITEM", 121000804, 1L), new QuestReward("SELECTABLE_ITEM", 121000805, 1L)), List.of(), Set.of(), "", 0, 1, 1, true, false, false, 0, null, null, false, Set.of(), 0, "NONE", "NONE", 0, List.of(), List.of(), List.of(), List.of(new QuestBonus("MEDICINE", 50, null)), List.of(), List.of(), Map.of());
	}
	...
	private static void addTransition276(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.TalkToNpc(204651, 8, 0)).from("reward").then(new QuestAction.GrantReward("GOLD", 0, 38500L, QuestRewardAmountMode.QUEST_BASE)).then(new QuestAction.GrantReward("EXP", 0, 2719217L, QuestRewardAmountMode.QUEST_BASE)).then(new QuestAction.GrantReward("ITEM", 186000005, 1L, QuestRewardAmountMode.EXACT)).then(new QuestAction.GrantReward("ITEM", 188050838, 1L, QuestRewardAmountMode.EXACT)).then(new QuestAction.GrantReward("ITEM", 121000804, 1L, QuestRewardAmountMode.EXACT)).then(new QuestAction.GrantReward("RANDOM", 10005, 1L, QuestRewardAmountMode.EXACT)).then(new QuestAction.CompleteQuest(0)).goTo("complete");
	...
	private static void addTransition277(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.TalkToNpc(204651, 9, 0)).from("reward").then(new QuestAction.GrantReward("GOLD", 0, 38500L, QuestRewardAmountMode.QUEST_BASE)).then(new QuestAction.GrantReward("EXP", 0, 2719217L, QuestRewardAmountMode.QUEST_BASE)).then(new QuestAction.GrantReward("ITEM", 186000005, 1L, QuestRewardAmountMode.EXACT)).then(new QuestAction.GrantReward("ITEM", 188050838, 1L, QuestRewardAmountMode.EXACT)).then(new QuestAction.GrantReward("ITEM", 121000805, 1L, QuestRewardAmountMode.EXACT)).then(new QuestAction.GrantReward("RANDOM", 10005, 1L, QuestRewardAmountMode.EXACT)).then(new QuestAction.CompleteQuest(0)).goTo("complete");
		builder.afterCommit(new AfterCommitAction.RefreshPlayerStats());
		builder.afterCommit(new AfterCommitAction.SyncQuestState(QuestStateSyncMode.COMPLETION));
		builder.afterCommit(new AfterCommitAction.ShowQuestSelectionDialog(10));
	}
