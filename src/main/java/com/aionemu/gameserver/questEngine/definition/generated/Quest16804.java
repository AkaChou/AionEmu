...
public final class Quest16804 {
	private Quest16804() {}

	public static CompiledQuestDefinition definition() {
		QuestDsl.QuestBuilder builder = QuestDsl.quest(16804)
			.version(1)
			.metadata(metadata());
	...
	private static QuestMetadata metadata() {
		return new QuestMetadata("Archives of Eternity Protector", 1802314, 66, 2147483647, Set.of("ELYOS"), "MISSION", new RepeatPolicy(1, 0L, false, false), Set.of(), List.of(), List.of(new QuestReward("GOLD", 0, 524340L), new QuestReward("EXP", 0, 41607965L)), List.of(), Set.of(), "", 0, 1, 1, true, false, false, 1, null, null, false, Set.of(), 0, "NONE", "NONE", 0, List.of(), List.of(), List.of(), List.of(), List.of(), List.of(), Map.ofEntries(Map.entry("FIGHTER", List.of(new QuestReward("ITEM", 121001491, 1L))), Map.entry("KNIGHT", List.of(new QuestReward("ITEM", 121001492, 1L))), Map.entry("RANGER", List.of(new QuestReward("ITEM", 121001494, 1L))), Map.entry("ASSASSIN", List.of(new QuestReward("ITEM", 121001493, 1L))), Map.entry("WIZARD", List.of(new QuestReward("ITEM", 121001497, 1L))), Map.entry("ELEMENTALIST", List.of(new QuestReward("ITEM", 121001498, 1L))), Map.entry("PRIEST", List.of(new QuestReward("ITEM", 121001496, 1L))), Map.entry("CHANTER", List.of(new QuestReward("ITEM", 121001495, 1L))), Map.entry("GUNSLINGER", List.of(new QuestReward("ITEM", 121001499, 1L))), Map.entry("SONGWEAVER", List.of(new QuestReward("ITEM", 121001500, 1L))), Map.entry("AETHERTECH", List.of(new QuestReward("ITEM", 121001501, 1L)))));
	}
	...
	private static void addTransition9(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.KillNpcSet(Set.of(857460, 857464, 857462))).from("started").goTo("k1");
