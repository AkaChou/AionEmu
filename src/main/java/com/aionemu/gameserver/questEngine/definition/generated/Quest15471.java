...
public final class Quest15471 {
	private Quest15471() {}

	public static CompiledQuestDefinition definition() {
		QuestDsl.QuestBuilder builder = QuestDsl.quest(15471)
			.version(1)
			.metadata(metadata());
	...
	private static QuestMetadata metadata() {
		return new QuestMetadata("[Landing Level 2/Weekly] Setting up the Outposts", 1801931, 66, 2147483647, Set.of("ELYOS"), "IMPORTANT", new RepeatPolicy(255, 0L, false, false), Set.of(), List.of(), List.of(new QuestReward("EXP", 0, 39767625L), new QuestReward("AP", 0, 3000L), new QuestReward("ITEM", 188100391, 500L)), List.of(), Set.of(), "", 0, 1, 1, true, false, false, 0, null, null, false, Set.of(), 0, "NONE", "NONE", 0, List.of(), List.of(), List.of(), List.of(), List.of(), List.of(), Map.of());
	}
	...
	private static void addTransition29(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.KillNpcSet(Set.of(883106, 883108, 883132, 883084, 883130, 883082, 882982, 883006, 882980, 883004, 882994, 882992))).from("started").goTo("reward");
		builder.afterCommit(new AfterCommitAction.SyncQuestState(QuestStateSyncMode.PACKET_ONLY));
	}
}
