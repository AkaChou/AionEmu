...
public final class Quest15474 {
	private Quest15474() {}

	public static CompiledQuestDefinition definition() {
		QuestDsl.QuestBuilder builder = QuestDsl.quest(15474)
			.version(1)
			.metadata(metadata());
	...
	private static void addTransition29(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.KillNpcSet(Set.of(883156, 883180, 883154, 883178, 883030, 883028, 883024, 883168, 883022, 883166, 883018, 883016))).from("started").goTo("reward");
		builder.afterCommit(new AfterCommitAction.SyncQuestState(QuestStateSyncMode.PACKET_ONLY));
	}
}
