...
public final class Quest30325 {
	private Quest30325() {}

	public static CompiledQuestDefinition definition() {
		QuestDsl.QuestBuilder builder = QuestDsl.quest(30325)
			.version(1)
			.metadata(metadata());
	...
	private static QuestMetadata metadata() {
		return new QuestMetadata("[Group] Do It For The Little Shulacks", 1114425, 53, 2147483647, Set.of("ASMODIANS"), "QUEST", new RepeatPolicy(255, 0L, false, false), Set.of(), List.of(new QuestItemRequirement(182209721, 6)), List.of(new QuestReward("GOLD", 0, 27100L), new QuestReward("EXP", 0, 5241977L), new QuestReward("ITEM", 182216246, 1L)), List.of(new QuestDrop(216238, 182209721, 30, true, 0, QuestDropScope.GROUP), new QuestDrop(216239, 182209721, 30, true, 0, QuestDropScope.GROUP), new QuestDrop(216240, 182209721, 30, true, 0, QuestDropScope.GROUP), new QuestDrop(216241, 182209721, 30, true, 0, QuestDropScope.GROUP), new QuestDrop(216242, 182209721, 30, true, 0, QuestDropScope.GROUP), new QuestDrop(216157, 182209721, 30, true, 0, QuestDropScope.GROUP), new QuestDrop(216158, 182209721, 30, true, 0, QuestDropScope.GROUP), new QuestDrop(216159, 182209721, 30, true, 0, QuestDropScope.GROUP), new QuestDrop(216160, 182209721, 30, true, 0, QuestDropScope.GROUP), new QuestDrop(216161, 182209721, 30, true, 0, QuestDropScope.GROUP), new QuestDrop(216243, 182209721, 30, true, 0, QuestDropScope.GROUP), new QuestDrop(216244, 182209721, 30, true, 0, QuestDropScope.GROUP), new QuestDrop(216245, 182209721, 30, true, 0, QuestDropScope.GROUP), new QuestDrop(216246, 182209721, 30, true, 0, QuestDropScope.GROUP), new QuestDrop(216247, 182209721, 30, true, 0, QuestDropScope.GROUP), new QuestDrop(216162, 182209721, 30, true, 0, QuestDropScope.GROUP), new QuestDrop(216163, 182209721, 30, true, 0, QuestDropScope.GROUP), new QuestDrop(216164, 182209721, 30, true, 0, QuestDropScope.GROUP), new QuestDrop(216165, 182209721, 30, true, 0, QuestDropScope.GROUP), new QuestDrop(216166, 182209721, 30, true, 0, QuestDropScope.GROUP), new QuestDrop(216248, 182209721, 30, true, 0, QuestDropScope.GROUP), new QuestDrop(216249, 182209721, 30, true, 0, QuestDropScope.GROUP), new QuestDrop(216250, 182209721, 30, true, 0, QuestDropScope.GROUP), new QuestDrop(216255, 182209721, 30, true, 0, QuestDropScope.GROUP), new QuestDrop(216257, 182209721, 30, true, 0, QuestDropScope.GROUP), new QuestDrop(216167, 182209721, 30, true, 0, QuestDropScope.GROUP), new QuestDrop(216168, 182209721, 30, true, 0, QuestDropScope.GROUP), new QuestDrop(216169, 182209721, 30, true, 0, QuestDropScope.GROUP), new QuestDrop(216174, 182209721, 30, true, 0, QuestDropScope.GROUP), new QuestDrop(216176, 182209721, 30, true, 0, QuestDropScope.GROUP), new QuestDrop(216259, 182209721, 30, true, 0, QuestDropScope.GROUP), new QuestDrop(216261, 182209721, 30, true, 0, QuestDropScope.GROUP), new QuestDrop(216263, 182209721, 30, true, 0, QuestDropScope.GROUP), new QuestDrop(216264, 182209721, 30, true, 0, QuestDropScope.GROUP), new QuestDrop(216178, 182209721, 30, true, 0, QuestDropScope.GROUP), new QuestDrop(216180, 182209721, 30, true, 0, QuestDropScope.GROUP), new QuestDrop(216182, 182209721, 30, true, 0, QuestDropScope.GROUP), new QuestDrop(216183, 182209721, 30, true, 0, QuestDropScope.GROUP)), Set.of(), "", 0, 1, 1, false, false, false, 0, null, null, false, Set.of(), 0, "NONE", "NONE", 0, List.of(), List.of(), List.of(), List.of(), List.of(), List.of(), Map.of());
	}
	...
	private static void addTransition10(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.TalkToNpc(216527, 39, 0)).from("started").priority(0).when(new QuestCondition.HasItem(182209721, 6, true)).then(new QuestAction.RemoveItem(182209721, 6)).goTo("reward");
	...
	private static void addTransition12(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.TalkToNpc(216527, 20002, 0)).from("started").priority(0).when(new QuestCondition.HasItem(182209721, 6, true)).then(new QuestAction.RemoveItem(182209721, 6)).goTo("reward");
		builder.afterCommit(new AfterCommitAction.SyncQuestState(QuestStateSyncMode.PACKET_ONLY));
		builder.afterCommit(new AfterCommitAction.ShowQuestDialog(5));
	}
