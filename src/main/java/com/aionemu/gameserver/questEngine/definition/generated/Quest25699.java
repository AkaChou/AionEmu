...
public final class Quest25699 {
	private Quest25699() {}

	public static CompiledQuestDefinition definition() {
		QuestDsl.QuestBuilder builder = QuestDsl.quest(25699)
			.version(1)
			.metadata(metadata());
	...
	private static QuestMetadata metadata() {
		return new QuestMetadata("[Weekly] Guardians after the Territory of Spiritus Base", 1803882, 70, 2147483647, Set.of("ASMODIANS"), "QUEST", new RepeatPolicy(255, 0L, false, true), Set.of(), List.of(), List.of(new QuestReward("GOLD", 0, 1500000L), new QuestReward("EXP", 0, 53023500L), new QuestReward("ITEM", 186000500, 3L)), List.of(), Set.of(), "", 0, 1, 1, false, false, false, 0, null, null, false, Set.of("WED"), 0, "NONE", "NONE", 0, List.of(), List.of(), List.of(), List.of(), List.of(), List.of(), Map.of());
	}
	...
	private static void addTransition10(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.TalkToNpc(806804, 1009, 0)).from("started").when(new QuestCondition.VariableAtLeast("var1", 5)).goTo("reward");
	...
	private static void addTransition29(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.KillNpcSet(Set.of(885457, 885456, 885455, 885458))).from("started").priority(1).when(new QuestCondition.VariableBelow("var1", 4)).then(new QuestAction.IncrementVariable("var1", 1)).goTo("started");
		builder.afterCommit(new AfterCommitAction.SyncQuestState(QuestStateSyncMode.PACKET_ONLY));
	}

	private static void addTransition30(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.KillNpcSet(Set.of(885457, 885456, 885455, 885458))).from("started").priority(0).when(new QuestCondition.VariableAtLeast("var1", 4)).then(new QuestAction.SetVariable("var1", 5)).goTo("reward");
		builder.afterCommit(new AfterCommitAction.SyncQuestState(QuestStateSyncMode.PACKET_ONLY));
	}
}
