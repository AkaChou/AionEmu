...
public final class Quest49710 {
	private Quest49710() {}

	public static CompiledQuestDefinition definition() {
		QuestDsl.QuestBuilder builder = QuestDsl.quest(49710)
			.version(1)
			.metadata(metadata());
	...
	private static void addTransition30(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.KillNpc(230510)).from("started").priority(1).when(new QuestCondition.VariableBelow("var0", 10)).then(new QuestAction.IncrementVariable("var0", 1)).goTo("started");
		builder.afterCommit(new AfterCommitAction.SyncQuestState(QuestStateSyncMode.PACKET_ONLY));
	}

	private static void addTransition31(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.KillNpc(230510)).from("started").priority(0).when(new QuestCondition.VariableAtLeast("var0", 10)).then(new QuestAction.SetVariable("var0", 10)).goTo("reward");
		builder.afterCommit(new AfterCommitAction.SyncQuestState(QuestStateSyncMode.PACKET_ONLY));
	}
