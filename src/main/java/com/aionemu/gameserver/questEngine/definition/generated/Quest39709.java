...
public final class Quest39709 {
	private Quest39709() {}

	public static CompiledQuestDefinition definition() {
		QuestDsl.QuestBuilder builder = QuestDsl.quest(39709)
			.version(1)
			.metadata(metadata());
	...
	private static QuestMetadata metadata() {
		return new QuestMetadata("[Daily] Everybody Must Get Stones", 1129785, 63, 2147483647, Set.of("ELYOS"), "FACTION", new RepeatPolicy(255, 0L, false, false), Set.of(), List.of(new QuestItemRequirement(182215284, 6)), List.of(new QuestReward("EXP", 0, 3251515L), new QuestReward("ITEM", 186000234, 3L), new QuestReward("ITEM", 188052288, 1L)), List.of(new QuestDrop(701567, 182215284, 100, true, 0, QuestDropScope.GROUP)), Set.of(), "", 0, 1, 1, true, false, false, 0, null, null, false, Set.of("ALL"), 0, "NONE", "NONE", 0, List.of(), List.of(), List.of(), List.of(), List.of(), List.of(), Map.of());
	}
	...
	private static void addTransition31(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.TalkToNpc(800936, 39, 0)).from("started").priority(0).when(new QuestCondition.HasItem(182215284, 6, true)).then(new QuestAction.RemoveItem(182215284, 6)).goTo("reward");
	...
	private static void addTransition33(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.TalkToNpc(800936, 20002, 0)).from("started").priority(0).when(new QuestCondition.HasItem(182215284, 6, true)).then(new QuestAction.RemoveItem(182215284, 6)).goTo("reward");
		builder.afterCommit(new AfterCommitAction.SyncQuestState(QuestStateSyncMode.PACKET_ONLY));
		builder.afterCommit(new AfterCommitAction.ShowQuestDialog(5));
	}
	...
	private static void addTransition36(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.TalkToNpc(800937, 39, 0)).from("started").priority(0).when(new QuestCondition.HasItem(182215284, 6, true)).then(new QuestAction.RemoveItem(182215284, 6)).goTo("reward");
		builder.afterCommit(new AfterCommitAction.SyncQuestState(QuestStateSyncMode.PACKET_ONLY));
		builder.afterCommit(new AfterCommitAction.ShowQuestDialog(5));
	}
	...
	private static void addTransition38(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.TalkToNpc(800937, 20002, 0)).from("started").priority(0).when(new QuestCondition.HasItem(182215284, 6, true)).then(new QuestAction.RemoveItem(182215284, 6)).goTo("reward");
		builder.afterCommit(new AfterCommitAction.SyncQuestState(QuestStateSyncMode.PACKET_ONLY));
		builder.afterCommit(new AfterCommitAction.ShowQuestDialog(5));
	}
	...
	private static void addTransition41(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.TalkToNpc(800938, 39, 0)).from("started").priority(0).when(new QuestCondition.HasItem(182215284, 6, true)).then(new QuestAction.RemoveItem(182215284, 6)).goTo("reward");
		builder.afterCommit(new AfterCommitAction.SyncQuestState(QuestStateSyncMode.PACKET_ONLY));
		builder.afterCommit(new AfterCommitAction.ShowQuestDialog(5));
	}
	...
	private static void addTransition43(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.TalkToNpc(800938, 20002, 0)).from("started").priority(0).when(new QuestCondition.HasItem(182215284, 6, true)).then(new QuestAction.RemoveItem(182215284, 6)).goTo("reward");
		builder.afterCommit(new AfterCommitAction.SyncQuestState(QuestStateSyncMode.PACKET_ONLY));
		builder.afterCommit(new AfterCommitAction.ShowQuestDialog(5));
	}
