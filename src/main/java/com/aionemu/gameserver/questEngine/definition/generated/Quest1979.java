...
public final class Quest1979 {
	private Quest1979() {}

	public static CompiledQuestDefinition definition() {
		QuestDsl.QuestBuilder builder = QuestDsl.quest(1979)
			.version(1)
			.metadata(metadata());
	...
	private static QuestMetadata metadata() {
		return new QuestMetadata("[Expert] Expert Of Cooking", 1102979, 29, 2147483647, Set.of("ELYOS"), "SIGNIFICANT", new RepeatPolicy(1, 0L, false, false), Set.of(), List.of(new QuestItemRequirement(182206902, 1), new QuestItemRequirement(182206903, 1), new QuestItemRequirement(182206904, 1), new QuestItemRequirement(182206905, 1)), List.of(new QuestReward("EXP", 0, 291412L)), List.of(), Set.of(), "", 0, 1, 1, true, false, false, 0, null, null, false, Set.of(), 0, "NONE", "NONE", 0, List.of(), List.of(), List.of(), List.of(), List.of(), List.of(new QuestStartCondition("finished", 1978, 0)), Map.of());
	}
