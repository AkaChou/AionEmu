...
public final class Quest3950 {
	private Quest3950() {}

	public static CompiledQuestDefinition definition() {
		QuestDsl.QuestBuilder builder = QuestDsl.quest(3950)
			.version(1)
			.metadata(metadata());
	...
	private static QuestMetadata metadata() {
		return new QuestMetadata("[Expert] Zest for Cooking", 1103071, 29, 2147483647, Set.of("ELYOS"), "SIGNIFICANT", new RepeatPolicy(1, 0L, false, false), Set.of(), List.of(new QuestItemRequirement(182206919, 1), new QuestItemRequirement(182206920, 1), new QuestItemRequirement(182206921, 1)), List.of(new QuestReward("EXP", 0, 291412L)), List.of(), Set.of(), "", 0, 1, 1, true, false, false, 0, 40001, 399, false, Set.of(), 0, "NONE", "NONE", 0, List.of(), List.of(), List.of(), List.of(), List.of(), List.of(new QuestStartCondition("finished", 1941, 0), new QuestStartCondition("finished", 1942, 0), new QuestStartCondition("finished", 1943, 0), new QuestStartCondition("finished", 1945, 0), new QuestStartCondition("finished", 1946, 0), new QuestStartCondition("unfinished", 3941, 0), new QuestStartCondition("unfinished", 3944, 0), new QuestStartCondition("unfinished", 3947, 0), new QuestStartCondition("unfinished", 3953, 0), new QuestStartCondition("unfinished", 3956, 0), new QuestStartCondition("unfinished", 1978, 0), new QuestStartCondition("noacquired", 3941, 0), new QuestStartCondition("noacquired", 3944, 0), new QuestStartCondition("noacquired", 3947, 0), new QuestStartCondition("noacquired", 3953, 0), new QuestStartCondition("noacquired", 3956, 0), new QuestStartCondition("noacquired", 1978, 0)), Map.of());
	}
	...
	private static void addTransition10(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.TalkToNpc(203784, 39, 0)).from("started").priority(0).when(new QuestCondition.HasItem(182206919, 1, true)).when(new QuestCondition.HasItem(182206920, 1, true)).when(new QuestCondition.HasItem(182206921, 1, true)).then(new QuestAction.RemoveItem(182206919, 1)).then(new QuestAction.RemoveItem(182206920, 1)).then(new QuestAction.RemoveItem(182206921, 1)).goTo("reward");
	...
	private static void addTransition12(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.TalkToNpc(203784, 20002, 0)).from("started").priority(0).when(new QuestCondition.HasItem(182206919, 1, true)).when(new QuestCondition.HasItem(182206920, 1, true)).when(new QuestCondition.HasItem(182206921, 1, true)).then(new QuestAction.RemoveItem(182206919, 1)).then(new QuestAction.RemoveItem(182206920, 1)).then(new QuestAction.RemoveItem(182206921, 1)).goTo("reward");
		builder.afterCommit(new AfterCommitAction.SyncQuestState(QuestStateSyncMode.PACKET_ONLY));
		builder.afterCommit(new AfterCommitAction.ShowQuestDialog(5));
	}
