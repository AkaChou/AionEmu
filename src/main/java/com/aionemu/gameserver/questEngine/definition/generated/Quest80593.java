...
public final class Quest80593 {
	private Quest80593() {}

	public static CompiledQuestDefinition definition() {
		QuestDsl.QuestBuilder builder = QuestDsl.quest(80593)
			.version(1)
			.metadata(metadata());
	...
	private static QuestMetadata metadata() {
		return new QuestMetadata("Into The Reliquary", 1185784, 65, 2147483647, Set.of("ASMODIANS"), "EVENT", new RepeatPolicy(1, 0L, false, false), Set.of(), List.of(), List.of(new QuestReward("DP", 0, 2000L), new QuestReward("ITEM", 164000259, 30L), new QuestReward("ITEM", 164000114, 20L), new QuestReward("ITEM", 164000116, 20L), new QuestReward("ITEM", 164002228, 3L), new QuestReward("ITEM", 161000004, 3L), new QuestReward("SELECTABLE_ITEM", 160002384, 20L), new QuestReward("SELECTABLE_ITEM", 160002386, 20L), new QuestReward("SELECTABLE_ITEM", 160002389, 20L)), List.of(), Set.of(), "", 0, 1, 1, false, false, false, 0, null, null, false, Set.of(), 0, "NONE", "NONE", 0, List.of(), List.of(), List.of(), List.of(), List.of(), List.of(), Map.of());
	}
	...
	private static void addTransition13(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.TalkToNpc(832268, 8, 0)).from("reward").then(new QuestAction.GrantReward("DP", 0, 2000L, QuestRewardAmountMode.EXACT)).then(new QuestAction.GrantReward("ITEM", 164000259, 30L, QuestRewardAmountMode.EXACT)).then(new QuestAction.GrantReward("ITEM", 164000114, 20L, QuestRewardAmountMode.EXACT)).then(new QuestAction.GrantReward("ITEM", 164000116, 20L, QuestRewardAmountMode.EXACT)).then(new QuestAction.GrantReward("ITEM", 164002228, 3L, QuestRewardAmountMode.EXACT)).then(new QuestAction.GrantReward("ITEM", 161000004, 3L, QuestRewardAmountMode.EXACT)).then(new QuestAction.GrantReward("ITEM", 160002384, 20L, QuestRewardAmountMode.EXACT)).then(new QuestAction.CompleteQuest(0)).goTo("complete");
	...
	private static void addTransition14(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.TalkToNpc(832268, 9, 0)).from("reward").then(new QuestAction.GrantReward("DP", 0, 2000L, QuestRewardAmountMode.EXACT)).then(new QuestAction.GrantReward("ITEM", 164000259, 30L, QuestRewardAmountMode.EXACT)).then(new QuestAction.GrantReward("ITEM", 164000114, 20L, QuestRewardAmountMode.EXACT)).then(new QuestAction.GrantReward("ITEM", 164000116, 20L, QuestRewardAmountMode.EXACT)).then(new QuestAction.GrantReward("ITEM", 164002228, 3L, QuestRewardAmountMode.EXACT)).then(new QuestAction.GrantReward("ITEM", 161000004, 3L, QuestRewardAmountMode.EXACT)).then(new QuestAction.GrantReward("ITEM", 160002386, 20L, QuestRewardAmountMode.EXACT)).then(new QuestAction.CompleteQuest(0)).goTo("complete");
		builder.afterCommit(new AfterCommitAction.RefreshPlayerStats());
		builder.afterCommit(new AfterCommitAction.SyncQuestState(QuestStateSyncMode.COMPLETION));
		builder.afterCommit(new AfterCommitAction.ShowQuestSelectionDialog(10));
	}
	...
	private static void addTransition15(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.TalkToNpc(832268, 10, 0)).from("reward").then(new QuestAction.GrantReward("DP", 0, 2000L, QuestRewardAmountMode.EXACT)).then(new QuestAction.GrantReward("ITEM", 164000259, 30L, QuestRewardAmountMode.EXACT)).then(new QuestAction.GrantReward("ITEM", 164000114, 20L, QuestRewardAmountMode.EXACT)).then(new QuestAction.GrantReward("ITEM", 164000116, 20L, QuestRewardAmountMode.EXACT)).then(new QuestAction.GrantReward("ITEM", 164002228, 3L, QuestRewardAmountMode.EXACT)).then(new QuestAction.GrantReward("ITEM", 161000004, 3L, QuestRewardAmountMode.EXACT)).then(new QuestAction.GrantReward("ITEM", 160002389, 20L, QuestRewardAmountMode.EXACT)).then(new QuestAction.CompleteQuest(0)).goTo("complete");
		builder.afterCommit(new AfterCommitAction.RefreshPlayerStats());
		builder.afterCommit(new AfterCommitAction.SyncQuestState(QuestStateSyncMode.COMPLETION));
		builder.afterCommit(new AfterCommitAction.ShowQuestSelectionDialog(10));
	}
