...
public final class Quest30330 {
	private Quest30330() {}

	public static CompiledQuestDefinition definition() {
		QuestDsl.QuestBuilder builder = QuestDsl.quest(30330)
			.version(1)
			.metadata(metadata());
	...
	private static QuestMetadata metadata() {
		return new QuestMetadata("Windy Wanting", 1114430, 53, 2147483647, Set.of("ASMODIANS"), "QUEST", new RepeatPolicy(1, 0L, false, false), Set.of(), List.of(new QuestItemRequirement(182209725, 30)), List.of(new QuestReward("GOLD", 0, 58950L), new QuestReward("EXP", 0, 6517414L), new QuestReward("ITEM", 186000098, 1L), new QuestReward("ITEM", 166100005, 25L)), List.of(new QuestDrop(216081, 182209725, 100, true, 0, QuestDropScope.GROUP), new QuestDrop(216452, 182209725, 100, true, 0, QuestDropScope.GROUP), new QuestDrop(216084, 182209725, 100, true, 0, QuestDropScope.GROUP), new QuestDrop(216453, 182209725, 100, true, 0, QuestDropScope.GROUP)), Set.of(), "", 0, 1, 1, true, false, false, 0, null, null, false, Set.of(), 0, "NONE", "NONE", 0, List.of(), List.of(), List.of(), List.of(), List.of(), List.of(new QuestStartCondition("finished", 30329, 0)), Map.of());
	}
	...
	private static void addTransition10(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.TalkToNpc(799321, 39, 0)).from("started").priority(0).when(new QuestCondition.HasItem(182209725, 30, true)).then(new QuestAction.RemoveItem(182209725, 30)).goTo("reward");
	...
	private static void addTransition12(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.TalkToNpc(799321, 20002, 0)).from("started").priority(0).when(new QuestCondition.HasItem(182209725, 30, true)).then(new QuestAction.RemoveItem(182209725, 30)).goTo("reward");
		builder.afterCommit(new AfterCommitAction.SyncQuestState(QuestStateSyncMode.PACKET_ONLY));
		builder.afterCommit(new AfterCommitAction.ShowQuestDialog(5));
	}
