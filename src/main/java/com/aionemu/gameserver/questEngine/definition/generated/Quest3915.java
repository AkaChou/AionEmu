...
public final class Quest3915 {
	private Quest3915() {}

	public static CompiledQuestDefinition definition() {
		QuestDsl.QuestBuilder builder = QuestDsl.quest(3915)
			.version(1)
			.metadata(metadata());
	...
	private static QuestMetadata metadata() {
		return new QuestMetadata("[Instance/Group] Obtaining Dragel", 1103046, 48, 2147483647, Set.of("ELYOS"), "QUEST", new RepeatPolicy(1, 0L, false, false), Set.of(), List.of(new QuestItemRequirement(182206068, 40)), List.of(new QuestReward("GOLD", 0, 25000L), new QuestReward("EXP", 0, 3773237L), new QuestReward("ITEM", 186000005, 1L), new QuestReward("ITEM", 188050836, 1L)), List.of(new QuestDrop(214831, 182206068, 100, true, 0, QuestDropScope.GROUP), new QuestDrop(214840, 182206068, 100, true, 0, QuestDropScope.GROUP), new QuestDrop(214856, 182206068, 100, true, 0, QuestDropScope.GROUP), new QuestDrop(214848, 182206068, 100, true, 0, QuestDropScope.GROUP), new QuestDrop(214857, 182206068, 100, true, 0, QuestDropScope.GROUP), new QuestDrop(214858, 182206068, 100, true, 0, QuestDropScope.GROUP), new QuestDrop(214859, 182206068, 100, true, 0, QuestDropScope.GROUP), new QuestDrop(214843, 182206068, 100, true, 0, QuestDropScope.GROUP), new QuestDrop(214877, 182206068, 100, true, 0, QuestDropScope.GROUP), new QuestDrop(214878, 182206068, 100, true, 0, QuestDropScope.GROUP), new QuestDrop(214887, 182206068, 100, true, 0, QuestDropScope.GROUP), new QuestDrop(214888, 182206068, 100, true, 0, QuestDropScope.GROUP), new QuestDrop(214885, 182206068, 100, true, 0, QuestDropScope.GROUP)), Set.of(), "", 0, 1, 1, true, false, false, 0, null, null, false, Set.of(), 0, "NONE", "NONE", 0, List.of(), List.of(), List.of(), List.of(), List.of(), List.of(), Map.of());
	}
	...
	private static void addTransition10(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.TalkToNpc(204656, 39, 0)).from("started").priority(0).when(new QuestCondition.HasItem(182206068, 40, true)).then(new QuestAction.RemoveItem(182206068, 40)).goTo("reward");
	...
	private static void addTransition12(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.TalkToNpc(204656, 20002, 0)).from("started").priority(0).when(new QuestCondition.HasItem(182206068, 40, true)).then(new QuestAction.RemoveItem(182206068, 40)).goTo("reward");
		builder.afterCommit(new AfterCommitAction.SyncQuestState(QuestStateSyncMode.PACKET_ONLY));
		builder.afterCommit(new AfterCommitAction.ShowQuestDialog(5));
	}
