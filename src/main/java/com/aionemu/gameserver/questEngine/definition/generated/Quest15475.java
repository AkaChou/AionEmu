...
public final class Quest15475 {
	private Quest15475() {}

	public static CompiledQuestDefinition definition() {
		QuestDsl.QuestBuilder builder = QuestDsl.quest(15475)
			.version(1)
			.metadata(metadata());
	...
	private static void addTransition29(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.KillNpcSet(Set.of(883204, 883036, 883202, 883034, 883216, 883046, 883048, 883192, 883190, 883214, 883042, 883040))).from("started").goTo("reward");
		builder.afterCommit(new AfterCommitAction.SyncQuestState(QuestStateSyncMode.PACKET_ONLY));
	}
}
