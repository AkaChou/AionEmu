...
public final class Quest18741 {
	private Quest18741() {}

	public static CompiledQuestDefinition definition() {
		QuestDsl.QuestBuilder builder = QuestDsl.quest(18741)
			.version(1)
			.metadata(metadata());
	...
	private static QuestMetadata metadata() {
		return new QuestMetadata("A Versed Order", 1800939, 60, 2147483647, Set.of("ELYOS"), "PRIMARY", new RepeatPolicy(10, 0L, false, false), Set.of(), List.of(), List.of(new QuestReward("EXP", 0, 9492173L), new QuestReward("ITEM", 186000231, 10L)), List.of(), Set.of(), "", 0, 1, 1, false, false, false, 0, null, null, false, Set.of(), 0, "NONE", "NONE", 0, List.of(), List.of(), List.of(), List.of(), List.of(), List.of(), Map.of());
	}
	...
	private static void addTransition3(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.TalkToNpc(804707, 1352, 0)).from("reward").goTo("reward");
