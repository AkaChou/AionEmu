...
public final class Quest49709 {
	private Quest49709() {}

	public static CompiledQuestDefinition definition() {
		QuestDsl.QuestBuilder builder = QuestDsl.quest(49709)
			.version(1)
			.metadata(metadata());
	...
	private static QuestMetadata metadata() {
		return new QuestMetadata("[Daily] Stones from the Lowest Bidder", 1129825, 63, 2147483647, Set.of("ASMODIANS"), "FACTION", new RepeatPolicy(255, 0L, false, false), Set.of(), List.of(new QuestItemRequirement(182215276, 6)), List.of(new QuestReward("EXP", 0, 3251515L), new QuestReward("ITEM", 186000234, 3L), new QuestReward("ITEM", 188052288, 1L)), List.of(new QuestDrop(701567, 182215276, 100, true, 0, QuestDropScope.GROUP)), Set.of(), "", 0, 1, 1, true, false, false, 0, null, null, false, Set.of(), 0, "NONE", "NONE", 0, List.of(), List.of(), List.of(), List.of(), List.of(), List.of(), Map.of());
	}
	...
	private static void addTransition22(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.TalkToNpc(800936, 39, 0)).from("started").priority(0).when(new QuestCondition.HasItem(182215276, 6, true)).then(new QuestAction.RemoveItem(182215276, 6)).goTo("reward");
		builder.afterCommit(new AfterCommitAction.SyncQuestState(QuestStateSyncMode.PACKET_ONLY));
		builder.afterCommit(new AfterCommitAction.ShowQuestDialog(5));
	}

	private static void addTransition23(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.TalkToNpc(800937, 39, 0)).from("started").priority(0).when(new QuestCondition.HasItem(182215276, 6, true)).then(new QuestAction.RemoveItem(182215276, 6)).goTo("reward");
		builder.afterCommit(new AfterCommitAction.SyncQuestState(QuestStateSyncMode.PACKET_ONLY));
		builder.afterCommit(new AfterCommitAction.ShowQuestDialog(5));
	}
	...
	private static void addTransition26(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.TalkToNpc(800936, 20002, 0)).from("started").priority(0).when(new QuestCondition.HasItem(182215276, 6, true)).then(new QuestAction.RemoveItem(182215276, 6)).goTo("reward");
		builder.afterCommit(new AfterCommitAction.SyncQuestState(QuestStateSyncMode.PACKET_ONLY));
		builder.afterCommit(new AfterCommitAction.ShowQuestDialog(5));
	}

	private static void addTransition27(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.TalkToNpc(800937, 20002, 0)).from("started").priority(0).when(new QuestCondition.HasItem(182215276, 6, true)).then(new QuestAction.RemoveItem(182215276, 6)).goTo("reward");
		builder.afterCommit(new AfterCommitAction.SyncQuestState(QuestStateSyncMode.PACKET_ONLY));
		builder.afterCommit(new AfterCommitAction.ShowQuestDialog(5));
	}
	...
	private static void addTransition32(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.TalkToNpc(800938, 39, 0)).from("started").priority(0).when(new QuestCondition.HasItem(182215276, 6, true)).then(new QuestAction.RemoveItem(182215276, 6)).goTo("reward");
		builder.afterCommit(new AfterCommitAction.SyncQuestState(QuestStateSyncMode.PACKET_ONLY));
		builder.afterCommit(new AfterCommitAction.ShowQuestDialog(5));
	}
	...
	private static void addTransition34(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.TalkToNpc(800938, 20002, 0)).from("started").priority(0).when(new QuestCondition.HasItem(182215276, 6, true)).then(new QuestAction.RemoveItem(182215276, 6)).goTo("reward");
		builder.afterCommit(new AfterCommitAction.SyncQuestState(QuestStateSyncMode.PACKET_ONLY));
		builder.afterCommit(new AfterCommitAction.ShowQuestDialog(5));
	}
