...
public final class Quest28976 {
	private Quest28976() {}

	public static CompiledQuestDefinition definition() {
		QuestDsl.QuestBuilder builder = QuestDsl.quest(28976)
			.version(1)
			.metadata(metadata());
	...
	private static QuestMetadata metadata() {
		return new QuestMetadata("Kaldor Fragments", 1801418, 65, 2147483647, Set.of("ASMODIANS"), "IMPORTANT", new RepeatPolicy(1, 0L, false, false), Set.of(), List.of(new QuestItemRequirement(182215821, 5)), List.of(new QuestReward("GOLD", 0, 301320L), new QuestReward("EXP", 0, 5169830L), new QuestReward("ITEM", 185000223, 1L)), List.of(new QuestDrop(234244, 182215821, 100, true, 0, QuestDropScope.GROUP), new QuestDrop(234517, 182215821, 100, true, 0, QuestDropScope.GROUP), new QuestDrop(234245, 182215821, 100, true, 0, QuestDropScope.GROUP), new QuestDrop(234503, 182215821, 100, true, 0, QuestDropScope.GROUP), new QuestDrop(234504, 182215821, 100, true, 0, QuestDropScope.GROUP), new QuestDrop(234246, 182215821, 100, true, 0, QuestDropScope.GROUP), new QuestDrop(234247, 182215821, 100, true, 0, QuestDropScope.GROUP), new QuestDrop(234260, 182215821, 100, true, 0, QuestDropScope.GROUP), new QuestDrop(234520, 182215821, 100, true, 0, QuestDropScope.GROUP), new QuestDrop(233997, 182215821, 100, true, 0, QuestDropScope.GROUP), new QuestDrop(234261, 182215821, 100, true, 0, QuestDropScope.GROUP), new QuestDrop(234262, 182215821, 100, true, 0, QuestDropScope.GROUP), new QuestDrop(234263, 182215821, 100, true, 0, QuestDropScope.GROUP), new QuestDrop(234512, 182215821, 100, true, 0, QuestDropScope.GROUP), new QuestDrop(234264, 182215821, 100, true, 0, QuestDropScope.GROUP)), Set.of(), "", 0, 1, 1, true, false, false, 0, null, null, false, Set.of(), 0, "NONE", "NONE", 0, List.of(), List.of(), List.of(), List.of(), List.of(), List.of(), Map.of());
	}
	...
	private static void addTransition9(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.CollectItem(182215821, 1)).from("started").goTo("started");
