...
public final class Quest4516 {
	private Quest4516() {}

	public static CompiledQuestDefinition definition() {
		QuestDsl.QuestBuilder builder = QuestDsl.quest(4516)
			.version(1)
			.metadata(metadata());
	...
	private static QuestMetadata metadata() {
		return new QuestMetadata("So Close Yet So Far", 1103766, 34, 2147483647, Set.of("ASMODIANS"), "QUEST", new RepeatPolicy(1, 0L, false, false), Set.of(2551), List.of(), List.of(new QuestReward("GOLD", 0, 9600L), new QuestReward("EXP", 0, 690971L), new QuestReward("ITEM", 162000048, 8L), new QuestReward("ITEM", 188050586, 1L)), List.of(), Set.of(), "", 0, 1, 1, true, false, false, 0, null, null, false, Set.of(), 0, "NONE", "NONE", 0, List.of(), List.of(), List.of(), List.of(), List.of(), List.of(), Map.of());
	}
	...
	private static void addTransition197(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.TalkToNpc(798119, 8, 0)).from("reward").then(new QuestAction.GrantReward("GOLD", 0, 9600L, QuestRewardAmountMode.QUEST_BASE)).then(new QuestAction.GrantReward("EXP", 0, 690971L, QuestRewardAmountMode.QUEST_BASE)).then(new QuestAction.GrantReward("ITEM", 162000048, 8L, QuestRewardAmountMode.EXACT)).then(new QuestAction.GrantReward("ITEM", 188050586, 1L, QuestRewardAmountMode.EXACT)).then(new QuestAction.CompleteQuest(0)).goTo("complete");
	...
	private static void addTransition198(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.TalkToNpc(798119, 9, 0)).from("reward").then(new QuestAction.GrantReward("GOLD", 0, 9600L, QuestRewardAmountMode.QUEST_BASE)).then(new QuestAction.GrantReward("EXP", 0, 690971L, QuestRewardAmountMode.QUEST_BASE)).then(new QuestAction.GrantReward("ITEM", 162000048, 8L, QuestRewardAmountMode.EXACT)).then(new QuestAction.GrantReward("ITEM", 188050586, 1L, QuestRewardAmountMode.EXACT)).then(new QuestAction.CompleteQuest(0)).goTo("complete");
		builder.afterCommit(new AfterCommitAction.RefreshPlayerStats());
		builder.afterCommit(new AfterCommitAction.SyncQuestState(QuestStateSyncMode.COMPLETION));
		builder.afterCommit(new AfterCommitAction.ShowQuestSelectionDialog(10));
	}
	...
	private static void addTransition199(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.TalkToNpc(798119, 10, 0)).from("reward").then(new QuestAction.GrantReward("GOLD", 0, 9600L, QuestRewardAmountMode.QUEST_BASE)).then(new QuestAction.GrantReward("EXP", 0, 690971L, QuestRewardAmountMode.QUEST_BASE)).then(new QuestAction.GrantReward("ITEM", 162000048, 8L, QuestRewardAmountMode.EXACT)).then(new QuestAction.GrantReward("ITEM", 188050586, 1L, QuestRewardAmountMode.EXACT)).then(new QuestAction.CompleteQuest(0)).goTo("complete");
		builder.afterCommit(new AfterCommitAction.RefreshPlayerStats());
		builder.afterCommit(new AfterCommitAction.SyncQuestState(QuestStateSyncMode.COMPLETION));
		builder.afterCommit(new AfterCommitAction.ShowQuestSelectionDialog(10));
	}
	...
	private static void addTransition200(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.TalkToNpc(798119, 11, 0)).from("reward").then(new QuestAction.GrantReward("GOLD", 0, 9600L, QuestRewardAmountMode.QUEST_BASE)).then(new QuestAction.GrantReward("EXP", 0, 690971L, QuestRewardAmountMode.QUEST_BASE)).then(new QuestAction.GrantReward("ITEM", 162000048, 8L, QuestRewardAmountMode.EXACT)).then(new QuestAction.GrantReward("ITEM", 188050586, 1L, QuestRewardAmountMode.EXACT)).then(new QuestAction.CompleteQuest(0)).goTo("complete");
		builder.afterCommit(new AfterCommitAction.RefreshPlayerStats());
		builder.afterCommit(new AfterCommitAction.SyncQuestState(QuestStateSyncMode.COMPLETION));
		builder.afterCommit(new AfterCommitAction.ShowQuestSelectionDialog(10));
	}
	...
	private static void addTransition201(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.TalkToNpc(798119, 12, 0)).from("reward").then(new QuestAction.GrantReward("GOLD", 0, 9600L, QuestRewardAmountMode.QUEST_BASE)).then(new QuestAction.GrantReward("EXP", 0, 690971L, QuestRewardAmountMode.QUEST_BASE)).then(new QuestAction.GrantReward("ITEM", 162000048, 8L, QuestRewardAmountMode.EXACT)).then(new QuestAction.GrantReward("ITEM", 188050586, 1L, QuestRewardAmountMode.EXACT)).then(new QuestAction.CompleteQuest(0)).goTo("complete");
		builder.afterCommit(new AfterCommitAction.RefreshPlayerStats());
		builder.afterCommit(new AfterCommitAction.SyncQuestState(QuestStateSyncMode.COMPLETION));
		builder.afterCommit(new AfterCommitAction.ShowQuestSelectionDialog(10));
	}
	...
	private static void addTransition202(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.TalkToNpc(798119, 13, 0)).from("reward").then(new QuestAction.GrantReward("GOLD", 0, 9600L, QuestRewardAmountMode.QUEST_BASE)).then(new QuestAction.GrantReward("EXP", 0, 690971L, QuestRewardAmountMode.QUEST_BASE)).then(new QuestAction.GrantReward("ITEM", 162000048, 8L, QuestRewardAmountMode.EXACT)).then(new QuestAction.GrantReward("ITEM", 188050586, 1L, QuestRewardAmountMode.EXACT)).then(new QuestAction.CompleteQuest(0)).goTo("complete");
		builder.afterCommit(new AfterCommitAction.RefreshPlayerStats());
		builder.afterCommit(new AfterCommitAction.SyncQuestState(QuestStateSyncMode.COMPLETION));
		builder.afterCommit(new AfterCommitAction.ShowQuestSelectionDialog(10));
	}
	...
	private static void addTransition203(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.TalkToNpc(798119, 14, 0)).from("reward").then(new QuestAction.GrantReward("GOLD", 0, 9600L, QuestRewardAmountMode.QUEST_BASE)).then(new QuestAction.GrantReward("EXP", 0, 690971L, QuestRewardAmountMode.QUEST_BASE)).then(new QuestAction.GrantReward("ITEM", 162000048, 8L, QuestRewardAmountMode.EXACT)).then(new QuestAction.GrantReward("ITEM", 188050586, 1L, QuestRewardAmountMode.EXACT)).then(new QuestAction.CompleteQuest(0)).goTo("complete");
		builder.afterCommit(new AfterCommitAction.RefreshPlayerStats());
		builder.afterCommit(new AfterCommitAction.SyncQuestState(QuestStateSyncMode.COMPLETION));
		builder.afterCommit(new AfterCommitAction.ShowQuestSelectionDialog(10));
	}
	...
	private static void addTransition204(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.TalkToNpc(798119, 15, 0)).from("reward").then(new QuestAction.GrantReward("GOLD", 0, 9600L, QuestRewardAmountMode.QUEST_BASE)).then(new QuestAction.GrantReward("EXP", 0, 690971L, QuestRewardAmountMode.QUEST_BASE)).then(new QuestAction.GrantReward("ITEM", 162000048, 8L, QuestRewardAmountMode.EXACT)).then(new QuestAction.GrantReward("ITEM", 188050586, 1L, QuestRewardAmountMode.EXACT)).then(new QuestAction.CompleteQuest(0)).goTo("complete");
		builder.afterCommit(new AfterCommitAction.RefreshPlayerStats());
		builder.afterCommit(new AfterCommitAction.SyncQuestState(QuestStateSyncMode.COMPLETION));
		builder.afterCommit(new AfterCommitAction.ShowQuestSelectionDialog(10));
	}
	...
	private static void addTransition205(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.TalkToNpc(798119, 16, 0)).from("reward").then(new QuestAction.GrantReward("GOLD", 0, 9600L, QuestRewardAmountMode.QUEST_BASE)).then(new QuestAction.GrantReward("EXP", 0, 690971L, QuestRewardAmountMode.QUEST_BASE)).then(new QuestAction.GrantReward("ITEM", 162000048, 8L, QuestRewardAmountMode.EXACT)).then(new QuestAction.GrantReward("ITEM", 188050586, 1L, QuestRewardAmountMode.EXACT)).then(new QuestAction.CompleteQuest(0)).goTo("complete");
		builder.afterCommit(new AfterCommitAction.RefreshPlayerStats());
		builder.afterCommit(new AfterCommitAction.SyncQuestState(QuestStateSyncMode.COMPLETION));
		builder.afterCommit(new AfterCommitAction.ShowQuestSelectionDialog(10));
	}
	...
	private static void addTransition206(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.TalkToNpc(798119, 17, 0)).from("reward").then(new QuestAction.GrantReward("GOLD", 0, 9600L, QuestRewardAmountMode.QUEST_BASE)).then(new QuestAction.GrantReward("EXP", 0, 690971L, QuestRewardAmountMode.QUEST_BASE)).then(new QuestAction.GrantReward("ITEM", 162000048, 8L, QuestRewardAmountMode.EXACT)).then(new QuestAction.GrantReward("ITEM", 188050586, 1L, QuestRewardAmountMode.EXACT)).then(new QuestAction.CompleteQuest(0)).goTo("complete");
		builder.afterCommit(new AfterCommitAction.RefreshPlayerStats());
		builder.afterCommit(new AfterCommitAction.SyncQuestState(QuestStateSyncMode.COMPLETION));
		builder.afterCommit(new AfterCommitAction.ShowQuestSelectionDialog(10));
	}
	...
	private static void addTransition207(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.TalkToNpc(798119, 18, 0)).from("reward").then(new QuestAction.GrantReward("GOLD", 0, 9600L, QuestRewardAmountMode.QUEST_BASE)).then(new QuestAction.GrantReward("EXP", 0, 690971L, QuestRewardAmountMode.QUEST_BASE)).then(new QuestAction.GrantReward("ITEM", 162000048, 8L, QuestRewardAmountMode.EXACT)).then(new QuestAction.GrantReward("ITEM", 188050586, 1L, QuestRewardAmountMode.EXACT)).then(new QuestAction.CompleteQuest(0)).goTo("complete");
		builder.afterCommit(new AfterCommitAction.RefreshPlayerStats());
		builder.afterCommit(new AfterCommitAction.SyncQuestState(QuestStateSyncMode.COMPLETION));
		builder.afterCommit(new AfterCommitAction.ShowQuestSelectionDialog(10));
	}
	...
	private static void addTransition208(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.TalkToNpc(798119, 19, 0)).from("reward").then(new QuestAction.GrantReward("GOLD", 0, 9600L, QuestRewardAmountMode.QUEST_BASE)).then(new QuestAction.GrantReward("EXP", 0, 690971L, QuestRewardAmountMode.QUEST_BASE)).then(new QuestAction.GrantReward("ITEM", 162000048, 8L, QuestRewardAmountMode.EXACT)).then(new QuestAction.GrantReward("ITEM", 188050586, 1L, QuestRewardAmountMode.EXACT)).then(new QuestAction.CompleteQuest(0)).goTo("complete");
		builder.afterCommit(new AfterCommitAction.RefreshPlayerStats());
		builder.afterCommit(new AfterCommitAction.SyncQuestState(QuestStateSyncMode.COMPLETION));
		builder.afterCommit(new AfterCommitAction.ShowQuestSelectionDialog(10));
	}
	...
	private static void addTransition210(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.TalkToNpc(798119, 21, 0)).from("reward").then(new QuestAction.GrantReward("GOLD", 0, 9600L, QuestRewardAmountMode.QUEST_BASE)).then(new QuestAction.GrantReward("EXP", 0, 690971L, QuestRewardAmountMode.QUEST_BASE)).then(new QuestAction.GrantReward("ITEM", 162000048, 8L, QuestRewardAmountMode.EXACT)).then(new QuestAction.GrantReward("ITEM", 188050586, 1L, QuestRewardAmountMode.EXACT)).then(new QuestAction.CompleteQuest(0)).goTo("complete");
		builder.afterCommit(new AfterCommitAction.RefreshPlayerStats());
		builder.afterCommit(new AfterCommitAction.SyncQuestState(QuestStateSyncMode.COMPLETION));
		builder.afterCommit(new AfterCommitAction.ShowQuestSelectionDialog(10));
	}
	...
	private static void addTransition211(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.TalkToNpc(798119, 22, 0)).from("reward").then(new QuestAction.GrantReward("GOLD", 0, 9600L, QuestRewardAmountMode.QUEST_BASE)).then(new QuestAction.GrantReward("EXP", 0, 690971L, QuestRewardAmountMode.QUEST_BASE)).then(new QuestAction.GrantReward("ITEM", 162000048, 8L, QuestRewardAmountMode.EXACT)).then(new QuestAction.GrantReward("ITEM", 188050586, 1L, QuestRewardAmountMode.EXACT)).then(new QuestAction.CompleteQuest(0)).goTo("complete");
		builder.afterCommit(new AfterCommitAction.RefreshPlayerStats());
		builder.afterCommit(new AfterCommitAction.SyncQuestState(QuestStateSyncMode.COMPLETION));
		builder.afterCommit(new AfterCommitAction.ShowQuestSelectionDialog(10));
	}
	...
	private static void addTransition212(QuestDsl.QuestBuilder builder) {
		builder.on(new QuestEvent.TalkToNpc(798119, 23, 0)).from("reward").then(new QuestAction.GrantReward("GOLD", 0, 9600L, QuestRewardAmountMode.QUEST_BASE)).then(new QuestAction.GrantReward("EXP", 0, 690971L, QuestRewardAmountMode.QUEST_BASE)).then(new QuestAction.GrantReward("ITEM", 162000048, 8L, QuestRewardAmountMode.EXACT)).then(new QuestAction.GrantReward("ITEM", 188050586, 1L, QuestRewardAmountMode.EXACT)).then(new QuestAction.CompleteQuest(0)).goTo("complete");
		builder.afterCommit(new AfterCommitAction.RefreshPlayerStats());
		builder.afterCommit(new AfterCommitAction.SyncQuestState(QuestStateSyncMode.COMPLETION));
		builder.afterCommit(new AfterCommitAction.ShowQuestSelectionDialog(10));
	}
