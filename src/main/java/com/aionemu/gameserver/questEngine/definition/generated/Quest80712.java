...
public final class Quest80712 {
	private Quest80712() {}

	public static CompiledQuestDefinition definition() {
		QuestDsl.QuestBuilder builder = QuestDsl.quest(80712)
			.version(1)
			.metadata(metadata());
	...
	private static QuestMetadata metadata() {
		return new QuestMetadata("[Event] All the Magical Energy to Our Team!", 1185845, 60, 2147483647, Set.of("ASMODIANS"), "EVENT", new RepeatPolicy(255, 0L, false, true), Set.of(), List.of(), List.of(new QuestReward("ITEM", 186000406, 8L)), List.of(), Set.of(), "", 0, 1, 1, false, false, false, 0, null, null, false, Set.of("WED"), 0, "NONE", "NONE", 0, List.of(), List.of(), List.of(), List.of(), List.of(), List.of(), Map.of());
	}
