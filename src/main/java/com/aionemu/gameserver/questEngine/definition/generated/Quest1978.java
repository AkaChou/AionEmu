...
public final class Quest1978 {
	private Quest1978() {}

	public static CompiledQuestDefinition definition() {
		QuestDsl.QuestBuilder builder = QuestDsl.quest(1978)
			.version(1)
			.metadata(metadata());
	...
	private static QuestMetadata metadata() {
		return new QuestMetadata("[Expert] Passion for Cooking", 1102978, 29, 2147483647, Set.of("ELYOS"), "SIGNIFICANT", new RepeatPolicy(1, 0L, false, false), Set.of(), List.of(new QuestItemRequirement(182206919, 1), new QuestItemRequirement(182206920, 1), new QuestItemRequirement(182206921, 1)), List.of(new QuestReward("EXP", 0, 291412L)), List.of(), Set.of(), "", 0, 1, 1, true, false, false, 0, null, null, false, Set.of(), 0, "NONE", "NONE", 0, List.of(), List.of(), List.of(), List.of(), List.of(), List.of(), Map.of());
	}
