 ...
 */
@Slf4j
public class GuideDAO extends com.aionemu.gameserver.dao.GuideDAO {
	...
	public boolean deleteGuide(int guide_id) {
		try (Connection con = DatabaseFactory.getConnection();
			...
			log.error(I18n.get("log.257617627810", guide_id, e), e);
			return false;
		}
	}
	...
	public List<Guide> loadGuides(int playerId) {
		...
		try (Connection con = DatabaseFactory.getConnection();
			...
			log.error(I18n.get("log.040d5371000d", playerId, " from DB", e), e);
		}
		return guides;
	}
	...
	public Guide loadGuide(int player_id, int guide_id) {
		...
		try (Connection con = DatabaseFactory.getConnection();
			...
			log.error(I18n.get("log.5857d08149b7", player_id, " from DB", e), e);
		}
		return guide;
	}
	...
	public void saveGuide(int guide_id, Player player, String title) {
		try (Connection con = DatabaseFactory.getConnection();
			...
			log.error(I18n.get("log.9ad0924840e7", player, e), e);
		}
	}
	...
	public int[] getUsedIDs() {
		...
		try (Connection con = DatabaseFactory.getConnection();
			...
			log.error(I18n.get("log.4c2e4d8e0a12", e), e);
			return new int[0];
		}
