 ...
 * 交互目标对象 ID / interaction target object id
 * 客户端发包前所在页面 / page shown by the client before sending the packet
 * 对话动作 ID / dialog action id
 * 客户端携带或记忆的任务 ID / quest id carried or remembered for this selection
 * 连续相同选择次数 / consecutive identical selection count
 * 最近一次选择的毫秒时间戳 / timestamp of the latest selection in milliseconds
 */
