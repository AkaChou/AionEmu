...
public class TitleAddAction extends AbstractItemAction {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.aionemu.gameserver.itemengine.actions.AbstractItemAction#canAct(com.
	 ...
	 * 
	 * @see
	 * com.aionemu.gameserver.itemengine.actions.AbstractItemAction#act(com.aionemu.
	 * gameserver.model.gameobjects.player .Player,
	 * com.aionemu.gameserver.model.gameobjects.Item,
	 * com.aionemu.gameserver.model.gameobjects.Item)
	 */
	@Override
	public void act(Player player, Item parentItem, Item targetItem) {
		...
		if (player.getTitleList().addTitle(titleid, false,
				minutes == null ? 0 : ((int) (System.currentTimeMillis() / 1000)) + minutes * 60)) {
