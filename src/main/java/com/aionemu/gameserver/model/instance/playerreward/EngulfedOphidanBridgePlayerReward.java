...
/**
 * EngulfedOphidanBridge 玩家奖励，用于副本相关逻辑。
 * Engulfed Ophidan Bridge Player Reward for instance logic.
 */
...
public class EngulfedOphidanBridgePlayerReward extends InstancePlayerReward {
	...
	/** 返回 ophidan victory box / Returns the ophidan victory box */
	...
	/** 设置 ophidan victory box / Sets the ophidan victory box */
