...
/**
 * 自动 SuspiciousOphidanBridge 副本，用于 autogroup 相关逻辑。
 * Auto Suspicious Ophidan Bridge Instance for autogroup logic.
 *
...
public class AutoSuspiciousOphidanBridgeInstance extends AutoInstance {
	...
	public void onPressEnter(Player player) {
		...
		GameBattlefieldServices.suspiciousOphidanBridgeService().addCoolDown(player);
