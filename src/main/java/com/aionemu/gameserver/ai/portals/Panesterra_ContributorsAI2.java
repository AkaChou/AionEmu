...
/**
 * 传送门/传送点 AI：Panesterra Contributors（@AIName "panesterra_contributors"），继承 GeneralNpcAI2。
 * Portal/teleporter AI: Panesterra Contributors (@AIName "panesterra_contributors"), extends GeneralNpcAI2.
 *
 * @author Encom
 */
...
public class Panesterra_ContributorsAI2 extends GeneralNpcAI2
{
	...
	protected void handleDialogStart(Player player) {
        switch (getNpcId()) {
			case 730942: // 贡献者晋升走廊。 / Advance Corridor For Contributors.
			case 730943: { // 贡献者晋升走廊。 / Advance Corridor For Contributors.
				...
				if (player.getLevel() >= 65) {
					...
					// 仅排名前 100 的玩家可进入。 / Only players ranked in the top 100 can enter.
