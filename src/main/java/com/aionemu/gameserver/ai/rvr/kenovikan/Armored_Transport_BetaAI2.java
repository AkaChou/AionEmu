...
/**
 * RvR 相关 NPC AI：Armored Transport Beta（@AIName "Armored_Transport_Beta"），继承 GeneralNpcAI2。
 * RvR-related NPC AI: Armored Transport Beta (@AIName "Armored_Transport_Beta"), extends GeneralNpcAI2.
 *
 * @author Encom
 */
...
public class Armored_Transport_BetaAI2 extends GeneralNpcAI2
{
	...
	private void announceF6RaidSumKill02DarkDie() {
		com.aionemu.gameserver.lifecycle.GameWorldBootstrapServices.world().doOnAllPlayers(new Visitor<Player>() {
			...
			public void visit(Player player) {
				if (player.isOnline()) {
					// 装甲运输贝塔被摧毁，部分玩家获得特殊效果。 / Armored Transport Beta was destroyed, and some users were given a special effect.
