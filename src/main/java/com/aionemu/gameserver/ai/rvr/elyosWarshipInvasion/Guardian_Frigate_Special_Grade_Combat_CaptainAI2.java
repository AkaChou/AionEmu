...
public class Guardian_Frigate_Special_Grade_Combat_CaptainAI2 extends AggressiveNpcAI2
{
	...
	protected void handleDied() {
		switch (Rnd.get(1, 3)) {
			case 1:
				spawn(240762, 1391.9735f, 1615.5792f, 1010.55457f, (byte) 25); // 露露兰 / Luluran.
			break;
			case 2:
				spawn(240763, 1391.9735f, 1615.5792f, 1010.55457f, (byte) 25); // 娜娜贝尔 / Nanabel.
			break;
			case 3:
				spawn(240764, 1391.9735f, 1615.5792f, 1010.55457f, (byte) 25); // 曼多斯 / Mandos.
			break;
		}
		super.handleDied();
		despawnNpc(240761); // 特等护卫舰突击队长 / Guardian Frigate Special Grade Assault Leader.
