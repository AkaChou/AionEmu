...
public class Exploration_Area_FlagAI2 extends ActionItemNpcAI2
{
	 ...
	 */
			...
			break;
			case 805940: // 探索区域旗帜 / Exploration Area Flag.
			    announceF6Invasion();
				explorationAreaStart1_2();
			    spawn(805941, 1256.1188f, 980.66156f, 322.22174f, (byte) 0, 500);
			break;
			case 805948: // 探索区域旗帜 / Exploration Area Flag.
			    announceF6Invasion();
	 ...
	 */
			...
			break;
			case 805942: // 探索区域旗帜 / Exploration Area Flag.
				announceF6Invasion();
				explorationAreaStart2_2();
			    spawn(805943, 1736.994f, 792.06250f, 309.298130f, (byte) 0, 2276);
			break;
			case 805950: // 探索区域旗帜 / Exploration Area Flag.
				announceF6Invasion();
	 ...
	 */
			...
			break;
			case 805944: // 探索区域旗帜 / Exploration Area Flag.
				announceF6Invasion();
				explorationAreaStart3_2();
			    spawn(805945, 1533.2758f, 1782.7814f, 313.42178f, (byte) 0, 353);
			break;
			case 805952: // 探索区域旗帜 / Exploration Area Flag.
				announceF6Invasion();
	 ...
	 */
			...
			break;
			case 805946: // 探索区域旗帜 / Exploration Area Flag.
				announceF6Invasion();
				explorationAreaStart4_2();
			    spawn(805947, 1934.3413f, 1449.7533f, 291.42267f, (byte) 0, 427);
			break;
			case 805954: // 探索区域旗帜 / Exploration Area Flag.
				announceF6Invasion();
