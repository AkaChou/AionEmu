...
/**
 * RvR 相关 NPC AI：Nanabel（@AIName "nanabel"），继承 AggressiveNpcAI2。
 * RvR-related NPC AI: Nanabel (@AIName "nanabel"), extends AggressiveNpcAI2.
 *
 * @author Encom
 */
@AIName("nanabel")
public class NanabelAI2 extends AggressiveNpcAI2
{
	...
	private void checkPercentage(int hpPercentage) {
		if (hpPercentage <= 75) {
			...
			spawn(240769, 1391.9735f, 1615.5792f, 1010.55457f, (byte) 25); // 指挥官娜娜贝尔 / Nanabel <Commander>
