...
/**
 * Evergale Canyon 副本 NPC AI：ID Eternity W Tele G To OP Up（@AIName "IDEternity_W_Tele_G_To_OP_Up"），继承 NpcAI2。
 * Evergale Canyon instance NPC AI: ID Eternity W Tele G To OP Up (@AIName "IDEternity_W_Tele_G_To_OP_Up"), extends NpcAI2.
 *
 * @author Encom
 */
