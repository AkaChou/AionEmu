...
/**
 * Anguished Dragon Lord Refuge 副本 NPC AI：ID Tiamat T1 Crystal Key Named65 Al（@AIName "petriscale2"），继承 AggressiveNpcAI2。
 * Anguished Dragon Lord Refuge instance NPC AI: ID Tiamat T1 Crystal Key Named65 Al (@AIName "petriscale2"), extends AggressiveNpcAI2.
 *
 * @author Encom
 */
@AIName("petriscale2")
