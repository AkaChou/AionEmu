...
/**
 * Illuminary Obelisk 副本 NPC AI：Eastern Shield Generator（@AIName "eastern_shield_generator"），继承 ActionItemNpcAI2。
 * Illuminary Obelisk instance NPC AI: Eastern Shield Generator (@AIName "eastern_shield_generator"), extends ActionItemNpcAI2.
 *
 * @author Encom
 */
