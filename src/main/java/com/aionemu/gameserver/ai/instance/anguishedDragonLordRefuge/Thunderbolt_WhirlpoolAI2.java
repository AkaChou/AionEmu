...
/**
 * Anguished Dragon Lord Refuge 副本 NPC AI：Thunderbolt Whirlpool（@AIName "thunderbolt_whirlpool"），继承 AggressiveNpcAI2。
 * Anguished Dragon Lord Refuge instance NPC AI: Thunderbolt Whirlpool (@AIName "thunderbolt_whirlpool"), extends AggressiveNpcAI2.
 *
 * @author Encom
 */
