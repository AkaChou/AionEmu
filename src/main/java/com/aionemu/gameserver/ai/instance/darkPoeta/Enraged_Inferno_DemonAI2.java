...
/**
 * Dark Poeta 副本 NPC AI：Enraged Inferno Demon（@AIName "enraged_inferno_demon"），继承 AggressiveNpcAI2。
 * Dark Poeta instance NPC AI: Enraged Inferno Demon (@AIName "enraged_inferno_demon"), extends AggressiveNpcAI2.
 *
 * @author Rinzler
...
public class Enraged_Inferno_DemonAI2 extends AggressiveNpcAI2
{
	...
	protected void handleAttack(Creature creature) {
		...
		if (isAggred.compareAndSet(false, true)) {
			switch (getNpcId()) {
				case 237372: // 愤怒的炼狱恶魔。 / Enraged Inferno Demon.
