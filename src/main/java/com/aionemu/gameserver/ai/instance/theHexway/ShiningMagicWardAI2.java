...
{
	/**
	 * 使用物品后按 NPC 类型与玩家当前地图将玩家传送到对应区域。
	 * After item use, teleports the player to the area matching the ward type and the player's current world.
	 */
	@Override
	protected void handleUseItemFinish(Player player) {
		switch (getNpcId()) {
		    case 700455: //闪耀魔法结界 / Shining Magic Ward.
				switch (player.getWorldId()) {
                    case 300080000: //左翼房间 / Left Wing Chamber.
                    ...
                    case 300700000: //六角道 4.3 / The Hexway 4.3.
