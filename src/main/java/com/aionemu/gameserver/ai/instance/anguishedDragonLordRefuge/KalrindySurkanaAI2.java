...
public class KalrindySurkanaAI2 extends NpcAI2
{
	...
	private void reflect() {
		skillTask = GameThreadPoolServices.threadPoolManager().scheduleAtFixedRate(() -> GameEngineServices.skillEngine().applyEffectDirectly(20891, getOwner(), kalrindy, 0), 3000, 10000);
	}
