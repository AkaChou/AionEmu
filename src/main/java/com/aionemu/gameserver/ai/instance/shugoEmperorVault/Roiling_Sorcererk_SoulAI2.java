			...
			switch (getNpcId()) {
			    case 833493: //Roiling Sorcererk's Soul.
				    if (player.getCommonData().getRace() == Race.ELYOS) {
				        ...
				        GameEngineServices.skillEngine().applyEffectDirectly(21831, player, player, 1200000); //Roiling Sorcererk's Soul.
					}
			    break;
				case 833496: //Roiling Sorcererk's Soul.
				    if (player.getCommonData().getRace() == Race.ASMODIANS) {
					    ...
					    GameEngineServices.skillEngine().applyEffectDirectly(21834, player, player, 1200000); //Roiling Sorcererk's Soul.
					}
			    break;
			}
		}
