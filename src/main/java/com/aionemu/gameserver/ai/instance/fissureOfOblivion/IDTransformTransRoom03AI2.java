...
/**
 * Fissure Of Oblivion 副本 NPC AI：ID Transform Trans Room03（@AIName "IDTransform_TransRoom_03"），继承 NpcAI2。
 * Fissure Of Oblivion instance NPC AI: ID Transform Trans Room03 (@AIName "IDTransform_TransRoom_03"), extends NpcAI2.
 *
 * @author Encom
 */
