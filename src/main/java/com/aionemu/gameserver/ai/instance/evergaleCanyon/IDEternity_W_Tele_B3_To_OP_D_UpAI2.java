...
/**
 * Evergale Canyon 副本 NPC AI：ID Eternity W Tele B3 To OP D Up（@AIName "IDEternity_W_Tele_B3_To_OP_D_Up"），继承 ActionItemNpcAI2。
 * Evergale Canyon instance NPC AI: ID Eternity W Tele B3 To OP D Up (@AIName "IDEternity_W_Tele_B3_To_OP_D_Up"), extends ActionItemNpcAI2.
 *
 * @author Encom
 */
