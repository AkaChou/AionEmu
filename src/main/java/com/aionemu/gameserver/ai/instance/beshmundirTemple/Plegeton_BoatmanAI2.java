...
/**
 * Beshmundir Temple 副本 NPC AI：Plegeton Boatman（@AIName "plegeton_boatman"），继承 NpcAI2。
 * Beshmundir Temple instance NPC AI: Plegeton Boatman (@AIName "plegeton_boatman"), extends NpcAI2.
 */
...
public class Plegeton_BoatmanAI2 extends NpcAI2
{
    ...
    public boolean onDialogSelect(final Player player, int dialogId, int questId, int extendedRewardIndex) {
        if (dialogId == 10000) {
            ...
            switch (getNpcId()) {
                case 799517: //Plegeton 船夫 [岛 I] / Plegeton Boatman [Island I]
                ...
                break;
                case 799518: //Plegeton 船夫 [岛 II] / Plegeton Boatman [Island II]
                    player.setState(CreatureState.FLIGHT_TELEPORT);
					player.unsetState(CreatureState.ACTIVE);
                ...
                break;
                case 799519: //Plegeton 船夫 [岛 III] / Plegeton Boatman [Island III]
                    player.setState(CreatureState.FLIGHT_TELEPORT);
					player.unsetState(CreatureState.ACTIVE);
                ...
                break;
                case 799520: //Plegeton 船夫 [岛 IV] / Plegeton Boatman [Island IV]
                    player.setState(CreatureState.FLIGHT_TELEPORT);
					player.unsetState(CreatureState.ACTIVE);
