...
/**
 * Iron Wall Warfront 副本 NPC AI：IDF5 TD War Chief L（@AIName "IDF5TDWar_chief_l"），继承 AggressiveNpcAI2。
 * Iron Wall Warfront instance NPC AI: IDF5 TD War Chief L (@AIName "IDF5TDWar_chief_l"), extends AggressiveNpcAI2.
 *
 * @author Encom
 */
