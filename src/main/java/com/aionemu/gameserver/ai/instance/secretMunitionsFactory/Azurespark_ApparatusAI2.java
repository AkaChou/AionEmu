...
public class Azurespark_ApparatusAI2 extends ActionItemNpcAI2
{
	@Override
	/**
	 * 在 Secret Munitions Factory 副本中使用装置后，清除副本内的所有 Azure Living Bomb。
	 * After using the apparatus in the Secret Munitions Factory instance, removes all azure living bombs in the instance.
	 */
