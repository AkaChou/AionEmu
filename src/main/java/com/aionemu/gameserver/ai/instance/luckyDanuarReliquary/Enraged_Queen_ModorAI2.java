package com.aionemu.gameserver.ai.instance.luckyDanuarReliquary;
...
/**
 * Lucky Danuar Reliquary 副本 NPC AI：Enraged Queen Modor（@AIName "enraged_queen_modor"），继承 AggressiveNpcAI2。
 * Lucky Danuar Reliquary instance NPC AI: Enraged Queen Modor (@AIName "enraged_queen_modor"), extends AggressiveNpcAI2.
 *
 * @author Encom
 */
...
public class Enraged_Queen_ModorAI2 extends AggressiveNpcAI2
{
    ...
    private void addPercent() {
        percents.clear();
        Collections.addAll(percents, 90, 85, 75, 70, 65, 60, 50, 45, 40, 35, 30, 25, 20, 15, 10, 5);
    }
...
spawn(284663, 268.12497f, 271.17401f, 242.625f, (byte) 90);
	...
	private void buff() {
		GameEngineServices.skillEngine().getSkill(getOwner(), 21169, 1, getOwner()).useNoAnimationSkill();
	}
