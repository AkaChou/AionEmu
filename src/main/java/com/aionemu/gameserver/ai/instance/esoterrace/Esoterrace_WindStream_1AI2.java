...
/**
 * Esoterrace 副本 NPC AI：Esoterrace Wind Stream 1（@AIName "Esoterrace_WindStream_1"），继承 NpcAI2。
 * Esoterrace instance NPC AI: Esoterrace Wind Stream 1 (@AIName "Esoterrace_WindStream_1"), extends NpcAI2.
 *
 * @author Encom
 */
