...
/**
 * Lucky Danuar Reliquary 副本 NPC AI：Cursed Queen Modor（@AIName "cursed_queen_modor"），继承 AggressiveNpcAI2。
 * Lucky Danuar Reliquary instance NPC AI: Cursed Queen Modor (@AIName "cursed_queen_modor"), extends AggressiveNpcAI2.
 *
 * @author Encom
 */
