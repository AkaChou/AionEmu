...
/**
 * Dragon Lord Refuge 副本 NPC AI：Graviwing（@AIName "graviwing"），继承 AggressiveNpcAI2。
 * Dragon Lord Refuge instance NPC AI: Graviwing (@AIName "graviwing"), extends AggressiveNpcAI2.
 *
 * @author Encom
 */
@AIName("graviwing")
