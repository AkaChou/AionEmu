...
/**
 * Dragon Lord Refuge 副本 NPC AI：Fissurefang（@AIName "fissurefang"），继承 AggressiveNpcAI2。
 * Dragon Lord Refuge instance NPC AI: Fissurefang (@AIName "fissurefang"), extends AggressiveNpcAI2.
 *
 * @author Encom
 */
@AIName("fissurefang")
