...
/**
 * Inggison 区域 NPC AI：Researcher Equipment（@AIName "researchersequipment"），继承 NpcAI2。
 * Inggison zone NPC AI: Researcher Equipment (@AIName "researchersequipment"), extends NpcAI2.
 *
 * @author Encom
 */
