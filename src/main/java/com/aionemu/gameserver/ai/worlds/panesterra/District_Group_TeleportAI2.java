...
/**
 * Panesterra 区域 NPC AI：District Group Teleport（@AIName "teleport_district"），继承 NpcAI2。
 * Panesterra zone NPC AI: District Group Teleport (@AIName "teleport_district"), extends NpcAI2.
 *
 * @author Encom
 */
