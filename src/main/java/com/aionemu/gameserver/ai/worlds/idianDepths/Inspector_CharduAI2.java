...
/**
 * Idian Depths 区域 NPC AI：Inspector Chardu（@AIName "inspector_chardu"），继承 AggressiveNpcAI2。
 * Idian Depths zone NPC AI: Inspector Chardu (@AIName "inspector_chardu"), extends AggressiveNpcAI2.
 *
 * @author Encom
 */
