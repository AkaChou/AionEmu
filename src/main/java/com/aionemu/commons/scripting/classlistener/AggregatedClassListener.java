...
public record AggregatedClassListener(List<ClassListener> classListeners) implements ClassListener {
	 ...
	 */
	@Override
	public List<ClassListener> classListeners() {
	...
	public void postLoad(Class<?>[] classes) {
		for (ClassListener cl : this.classListeners()) {
			cl.postLoad(classes);
		}
	}
	...
	public void preUnload(Class<?>[] classes) {
		for (ClassListener cl : Lists.reverse(this.classListeners())) {
