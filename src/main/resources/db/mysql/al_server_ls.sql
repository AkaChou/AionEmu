...
--
-- Host: localhost    Database: al_server_ls
-- ------------------------------------------------------
...
--
-- Current Database: `al_server_ls`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `al_server_ls` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
CREATE TABLE `account_data` (
  ...
  `access_level` tinyint(3) NOT NULL DEFAULT '5',
...
INSERT INTO `gameservers` VALUES (1,'*','sunaion');
...
--
-- Dumping data for table `svstats`
--

LOCK TABLES `svstats` WRITE;
/*!40000 ALTER TABLE `svstats` DISABLE KEYS */;
/*!40000 ALTER TABLE `svstats` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping events for database 'al_server_ls'
--

--
-- Dumping routines for database 'al_server_ls'
--
