...
class RetailConditionSpawnPartyLoaderTest {
	...
	void loadsPartyAsOneProbabilisticChoiceWithSharedToken() throws Exception {
		...
		Files.writeString(conditions, """
			...
			<npc id="1" probability="10000" x="1" y="2" z="3" heading="90" initial_delay="0" initial_delay_extra="0" life="20" respawn_time="1"/>
		...
		assertEquals(1, choice.members().get(0).respawnTime());
	}
}
