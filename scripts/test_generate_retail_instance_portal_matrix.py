...
class InstancePortalMatrixTest(unittest.TestCase):
    ...
    def test_full_matrix_counts(self) -> None:
        ...
        self.assertEqual({
            ...
            "routes": 842,
            "batches": 95,
            "routes_by_association": {"DESTINATION": 354, "START": 488},
            "routes_by_mechanism": {
                "handler": 23,
                "legacy_ai": 69,
                "portal_dialog": 429,
            ...
            "routes_by_type_status": {"RETAIL_PROVEN": 84, "RUNTIME_MODELED": 758},
    ...
    def test_transport_types_and_endpoints_have_closed_batch_dimensions(self) -> None:
        ...
        self.assertEqual(84, sum(route["type_status"] == "RETAIL_PROVEN" for route in self.routes))
